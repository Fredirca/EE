...
{
	ShowConfirmDialog( 'Ai Steam?', 'Nu am putut găsi Steam să ruleze pe calculator. Dorești să lansezi discuțiile web?',
		'Folosește discuțiile web' , null, 'Obține Steam' ).done( function( choice ) {
			if ( choice == 'OK' )
				fnLaunchWebchat();
			else
...
function InitCookiePreferencesPopup()
{
	...
	if ( $popupDialog.length == 0 )
	{
		...
		var $CPopupContent = $J( "<style>\n.replyButton {\n\twidth: 100%;\n    text-align: center;\n    margin-bottom: 4px;\n}\n\n.buttonGroup {\n\tflex: 18%;\n\tmargin-left: 20px;\n\tmargin-right: 0px;\n}\n.cookieMessage {\n\tflex: 85%;\n\tmargin: auto;\n}\n.popupTextTitle {\n\tpadding-bottom: 10px;\n    font-size: 13px;\n    line-height: 17px;\n    color: #c6d4df;\n}\n.popupTextTitle a {\n    text-decoration: underline;\n}\n.cookiepreferences_popup {\n\tdisplay: none;\n\tposition: fixed;\n\tbottom: 0;\n\twidth: 100%;\n\tz-index: 2000;\n\tpadding-top: 10px;\n}\n.cookiepreferences_popup_content {\n\tdisplay: flex;\n    box-sizing: border-box;\n\twidth: 90%;\n\tmargin: auto;\n\tmargin-bottom: 20px;\n\tpadding: 16px 16px 10px 16px;\n    max-width: 980px;\n\tbackground: linear-gradient(90.85deg, #333840 0.58%, #25282E 74.92%);\n\tbox-shadow: 0px 0px 10px #000000;\n    border-left: 2px solid #00CCFF;\n}\n@media all and (max-width: 910px) {\n    body.responsive_page .cookiepreferences_popup_content {\n        flex-direction: column;\n    }\n    body.responsive_page .cookiepreferences_popup_content .cookieMessage {\n        margin-bottom: 20px;\n    }\n    body.responsive_page .cookiepreferences_popup_content .buttonGroup {\n        flex-direction: row;\n        margin-left: 0px;\n    }\n    body.responsive_page .cookiepreferences_popup_content .buttonGroup .replyButton {\n        width: unset;\n    }\n}\n<\/style>\n\n<div id=\"cookiePrefPopup\" class=\"cookiepreferences_popup\">\n\t<div class=\"cookiepreferences_popup_content\">\n\t\t<div class=\"cookieMessage\">\n\t\t\t<div class=\"popupTextTitle\">Putem utiliza cookie-uri op\u021bionale pentru a-\u021bi oferi con\u021binut personalizat \u0219i pentru a analiza traficul site-ului?<\/div>\n\t\t\t<div class=\"popupTextTitle\">Noi nu folosim foarte multe cookie-uri; le po\u021bi vizualiza \u0219i gestiona oric\u00e2nd pe <a href=\"https:\/\/store.steampowered.com\/account\/cookiepreferences\">pagina noastr\u0103 de configurare a cookie-urilor<\/a>. Dac\u0103 ape\u0219i pe \u201eAccept\u0103 toate\u201d, te declari de acord cu utilizarea cookie-urilor pe site-urile web Steam. Pentru mai multe informa\u021bii cu privire la cookie-uri consult\u0103 <a href=\"https:\/\/store.steampowered.com\/privacy_agreement\">politica noastr\u0103 de confiden\u021bialitate<\/a>.<\/div>\n\t\t<\/div>\n\t\t<div class=\"buttonGroup\">\n\t\t\t<div id=\"acceptAllButton\" class=\"btn_blue_steamui btn_medium replyButton\"><span>Accept\u0103 tot<\/span><\/div>\n\t\t\t<div id=\"rejectAllButton\" class=\"btn_grey_steamui btn_medium replyButton\"><span>Respinge tot<\/span><\/div>\n\t\t<\/div>\n\t<\/div>\n<\/div>\n" );
	...
	.fail( function( jqxhr ) {
		...
		switch ( responseJSON.success )
		{
			case 21:
				...
				break;
			case 24:
				ShowAlertDialog( 'Eroare',
					'Contul tău nu îndeplinește cerințele pentru a utiliza această facilitate. <a class="whiteLink" href="https://help.steampowered.com/ro/wizard/HelpWithLimitedAccount" target="_blank" rel="noreferrer">Vizitează Asistența Steam</a> pentru mai multe informații.'
				);
				break;
			case 15:
				ShowAlertDialog( 'Eroare', 'Nu ai permisiune pentru a efectua acea acțiune.' );
				break;
			default:
				ShowAlertDialog( 'Eroare', 'A apărut o eroare în timpul procesării cererii tale:' + responseJSON.success );
				break;
		}
	} );
	return false;
...
CAjaxInfiniteScrollingControls.prototype.RestoreScrollTop = function( bForce )
{
	...
	if ( scrollTopPrevious )
	{
		...
		else
		{
			...
			{
				this.m_LoadingDialog = ShowBlockingWaitDialog( 'Te rugăm așteaptă', 'Întoarcere către unde erai precedent pe această pagină...' );
			}
			window.scrollTo( 0, scrollTopPrevious );
		}
	}
...
function LockFamilyView( bStore )
{
	...
	ShowConfirmDialog( 'Revenire la modul familial',
		'Ești sigur că vrei să revii la modul familial?',
		'Revenire la modul familial'
	).done( function() {
		ShowBlockingWaitDialog( 'Revenire la modul familial' );
			...
			if ( typeof rgSuggestions[i][1] !== 'undefined' )
			{
				switch ( parseInt( rgSuggestions[i][1] ) )
				{
					case 1:
						...
						suggestionText = '[Joc] ' + suggestionText;
						break;
					case 2:
						suggestionText = '[Aplicație] ' + suggestionText;
						break;
					case 4:
						suggestionText = '[Instrument] ' + suggestionText;
						break;
					case 8:
					...
					case 32:
						...
						break;
					case 256:
						suggestionText = '[Configurație] ' + suggestionText;
						break;
					case 2048:
						resultClass += ' app_Movie';
						suggestionText = '[Conținut video] ' + suggestionText;
						break;
					case 8192:
						resultClass += ' app_Music';
						suggestionText = '[Muzică] ' + suggestionText;
						break;
					case 65536:
						resultClass += ' app_Beta';
						suggestionText = '[Versiune beta] ' + suggestionText;
						break;
				}
			}
...
{
	var waitDialog = ShowBlockingWaitDialog( 'Exemple de produse', 'Te rugăm să aștepți în timp ce găsim unele produse drept exemple...' );
	...
	$J.get( 'https://store.steampowered.com/search/results/',
		...
		{
			content.append( $J( "<div>", { class: "no_items", text: 'Nu au fost găsite produse' } ) );
		}

		var dialog = ShowAlertDialog( 'Exemple de produse', content );
	} );
}
