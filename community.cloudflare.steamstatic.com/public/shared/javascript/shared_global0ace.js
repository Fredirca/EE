...
{
	ShowConfirmDialog( 'Heb je Steam al?', 'Steam is niet op je apparaat gevonden. Wil je de webchat openen?',
		'Webchat gebruiken' , null, 'Steam downloaden' ).done( function( choice ) {
			if ( choice == 'OK' )
				fnLaunchWebchat();
			else
...
function InitCookiePreferencesPopup()
{
	...
	if ( $popupDialog.length == 0 )
	{
		...
		var $CPopupContent = $J( "<style>\n.replyButton {\n\twidth: 100%;\n    text-align: center;\n    margin-bottom: 4px;\n}\n\n.buttonGroup {\n\tflex: 18%;\n\tmargin-left: 20px;\n\tmargin-right: 0px;\n}\n.cookieMessage {\n\tflex: 85%;\n\tmargin: auto;\n}\n.popupTextTitle {\n\tpadding-bottom: 10px;\n    font-size: 13px;\n    line-height: 17px;\n    color: #c6d4df;\n}\n.popupTextTitle a {\n    text-decoration: underline;\n}\n.cookiepreferences_popup {\n\tdisplay: none;\n\tposition: fixed;\n\tbottom: 0;\n\twidth: 100%;\n\tz-index: 2000;\n\tpadding-top: 10px;\n}\n.cookiepreferences_popup_content {\n\tdisplay: flex;\n    box-sizing: border-box;\n\twidth: 90%;\n\tmargin: auto;\n\tmargin-bottom: 20px;\n\tpadding: 16px 16px 10px 16px;\n    max-width: 980px;\n\tbackground: linear-gradient(90.85deg, #333840 0.58%, #25282E 74.92%);\n\tbox-shadow: 0px 0px 10px #000000;\n    border-left: 2px solid #00CCFF;\n}\n@media all and (max-width: 910px) {\n    body.responsive_page .cookiepreferences_popup_content {\n        flex-direction: column;\n    }\n    body.responsive_page .cookiepreferences_popup_content .cookieMessage {\n        margin-bottom: 20px;\n    }\n    body.responsive_page .cookiepreferences_popup_content .buttonGroup {\n        flex-direction: row;\n        margin-left: 0px;\n    }\n    body.responsive_page .cookiepreferences_popup_content .buttonGroup .replyButton {\n        width: unset;\n    }\n}\n<\/style>\n\n<div id=\"cookiePrefPopup\" class=\"cookiepreferences_popup\">\n\t<div class=\"cookiepreferences_popup_content\">\n\t\t<div class=\"cookieMessage\">\n\t\t\t<div class=\"popupTextTitle\">We gebruiken optionele cookies om je gepersonaliseerde inhoud te bezorgen en om websiteverkeer te analyseren. Ga je daarmee akkoord?<\/div>\n\t\t\t<div class=\"popupTextTitle\">We maken slechts van enkele cookies gebruik. Je kunt ze wanneer je maar wilt bekijken en beheren op onze <a href=\"https:\/\/store.steampowered.com\/account\/cookiepreferences\">pagina met cookie-instellingen<\/a>. Als je op Alles accepteren klikt, dan geef je toestemming voor het gebruik van cookies op de websites van Steam. Meer informatie over cookies vind je in ons <a href=\"https:\/\/store.steampowered.com\/privacy_agreement\">privacybeleid (Privacy Policy)<\/a>.<\/div>\n\t\t<\/div>\n\t\t<div class=\"buttonGroup\">\n\t\t\t<div id=\"acceptAllButton\" class=\"btn_blue_steamui btn_medium replyButton\"><span>Alles accepteren<\/span><\/div>\n\t\t\t<div id=\"rejectAllButton\" class=\"btn_grey_steamui btn_medium replyButton\"><span>Alles weigeren<\/span><\/div>\n\t\t<\/div>\n\t<\/div>\n<\/div>\n" );
		...
		switch ( responseJSON.success )
		{
			...
			case 24:
				ShowAlertDialog( 'Fout',
					'Je account voldoet niet aan de vereisten om deze functie te gebruiken. Bezoek <a class="whiteLink" href="https://help.steampowered.com/nl/wizard/HelpWithLimitedAccount" target="_blank" rel="noreferrer">Steam Support</a> voor meer informatie.'
				);
				break;
			case 15:
				...
				break;
			default:
				ShowAlertDialog( 'Fout', 'Er is een fout opgetreden bij het verwerken van je verzoek: ' + responseJSON.success );
				break;
		}
	} );
	return false;
...
CAjaxInfiniteScrollingControls.prototype.RestoreScrollTop = function( bForce )
{
	...
	if ( scrollTopPrevious )
	{
		...
		else
		{
			...
			{
				this.m_LoadingDialog = ShowBlockingWaitDialog( 'Even geduld', 'Je wordt nu terugverwezen naar waar je vandaan kwam...' );
			}
			window.scrollTo( 0, scrollTopPrevious );
		}
	}
			...
			if ( typeof rgSuggestions[i][1] !== 'undefined' )
			{
				switch ( parseInt( rgSuggestions[i][1] ) )
				{
					case 1:
						...
						break;
					case 2:
						suggestionText = '[Applicatie] ' + suggestionText;
						break;
					case 4:
					...
					case 32:
						...
						break;
					case 256:
						suggestionText = '[Configuratie] ' + suggestionText;
						break;
					case 2048:
					...
					case 8192:
						...
						suggestionText = '[Muziek] ' + suggestionText;
						break;
					case 65536:
						resultClass += ' app_Beta';
						suggestionText = '[Bèta] ' + suggestionText;
						break;
				}
			}
...
{
	var waitDialog = ShowBlockingWaitDialog( 'Voorbeeldproducten', 'Even geduld terwijl we wat voorbeeldproducten zoeken ...' );
	...
	$J.get( 'https://store.steampowered.com/search/results/',
		...
		{
			content.append( $J( "<div>", { class: "no_items", text: 'Geen producten gevonden' } ) );
		}

		var dialog = ShowAlertDialog( 'Voorbeeldproducten', content );
	} );
}
