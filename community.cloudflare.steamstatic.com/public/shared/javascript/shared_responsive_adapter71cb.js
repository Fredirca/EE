...
jQuery( function($) {
	...
	if ( $LocalMenuContent.length )
	{
		...
		GPNavUpdateActionDescriptions( $('#responsive_page_template_content'), { onOptionsActionDescription:'Menú' } );
...
function Responsive_BuildChangeLanguageOption( $MenuItem )
{
	$MenuItem.click( function() {
		...
		$SelectBox.append(
			$J('<option/>', {value: "spanish"} ).text( 'Español de España' )
		);
					$SelectBox.append(
				$J('<option/>', {value: "schinese"} ).text( '简体中文 (chino simplificado)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "tchinese"} ).text( '繁體中文 (chino tradicional)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "japanese"} ).text( '日本語 (japonés)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "koreana"} ).text( '한국어 (coreano)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "thai"} ).text( 'ไทย (tailandés)' )
			);
					$SelectBox.append(
				...
				$J('<option/>', {value: "czech"} ).text( 'Čeština (checo)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "danish"} ).text( 'Dansk (danés)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "german"} ).text( 'Deutsch (alemán)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "english"} ).text( 'English (inglés)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "latam"} ).text( 'Español de Hispanoamérica' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "greek"} ).text( 'Ελληνικά (griego)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "french"} ).text( 'Français (francés)' )
			);
					$SelectBox.append(
				...
				$J('<option/>', {value: "hungarian"} ).text( 'Magyar (húngaro)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "dutch"} ).text( 'Nederlands (holandés)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "norwegian"} ).text( 'Norsk (noruego)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "polish"} ).text( 'Polski (polaco)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "portuguese"} ).text( 'Português (Portugués de Portugal)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "brazilian"} ).text( 'Português-Brasil (portugués de Brasil)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "romanian"} ).text( 'Română (rumano)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "russian"} ).text( 'Русский (ruso)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "finnish"} ).text( 'Suomi (finés)' )
			);
					$SelectBox.append(
		...
		Modal = ShowConfirmDialog( 'Cambiar idioma', $LanguageForm, 'Cambiar idioma' ).done( fnChangeLanguage );
		$SelectBox.focus();
	});
}
