...
{
	ShowConfirmDialog( 'Har du Steam?', 'Vi kunne ikke finde en kørende instans af Steam på din maskine. Vil du åbne webchatten?',
		'Brug webchat' , null, 'Hent Steam' ).done( function( choice ) {
			if ( choice == 'OK' )
				fnLaunchWebchat();
			else
...
function InitCookiePreferencesPopup()
{
	...
	if ( $popupDialog.length == 0 )
	{
		...
		var $CPopupContent = $J( "<style>\n.replyButton {\n\twidth: 100%;\n    text-align: center;\n    margin-bottom: 4px;\n}\n\n.buttonGroup {\n\tflex: 18%;\n\tmargin-left: 20px;\n\tmargin-right: 0px;\n}\n.cookieMessage {\n\tflex: 85%;\n\tmargin: auto;\n}\n.popupTextTitle {\n\tpadding-bottom: 10px;\n    font-size: 13px;\n    line-height: 17px;\n    color: #c6d4df;\n}\n.popupTextTitle a {\n    text-decoration: underline;\n}\n.cookiepreferences_popup {\n\tdisplay: none;\n\tposition: fixed;\n\tbottom: 0;\n\twidth: 100%;\n\tz-index: 2000;\n\tpadding-top: 10px;\n}\n.cookiepreferences_popup_content {\n\tdisplay: flex;\n    box-sizing: border-box;\n\twidth: 90%;\n\tmargin: auto;\n\tmargin-bottom: 20px;\n\tpadding: 16px 16px 10px 16px;\n    max-width: 980px;\n\tbackground: linear-gradient(90.85deg, #333840 0.58%, #25282E 74.92%);\n\tbox-shadow: 0px 0px 10px #000000;\n    border-left: 2px solid #00CCFF;\n}\n@media all and (max-width: 910px) {\n    body.responsive_page .cookiepreferences_popup_content {\n        flex-direction: column;\n    }\n    body.responsive_page .cookiepreferences_popup_content .cookieMessage {\n        margin-bottom: 20px;\n    }\n    body.responsive_page .cookiepreferences_popup_content .buttonGroup {\n        flex-direction: row;\n        margin-left: 0px;\n    }\n    body.responsive_page .cookiepreferences_popup_content .buttonGroup .replyButton {\n        width: unset;\n    }\n}\n<\/style>\n\n<div id=\"cookiePrefPopup\" class=\"cookiepreferences_popup\">\n\t<div class=\"cookiepreferences_popup_content\">\n\t\t<div class=\"cookieMessage\">\n\t\t\t<div class=\"popupTextTitle\">Er det i orden, at vi bruger valgfrie cookies til at give dig personligt indhold og analysere trafik til sider?<\/div>\n\t\t\t<div class=\"popupTextTitle\">Vi bruger ikke mange cookies. Du kan se og administrere dem n\u00e5r som helst p\u00e5 vores <a href=\"https:\/\/store.steampowered.com\/account\/cookiepreferences\">side med cookieindstillinger<\/a>. Hvis du klikker \"Accepter alle\", giver du samtykke til brug af cookies p\u00e5 Steam-hjemmesider. L\u00e6s mere om cookies i vores <a href=\"https:\/\/store.steampowered.com\/privacy_agreement\">fortrolighedspolitik<\/a>.<\/div>\n\t\t<\/div>\n\t\t<div class=\"buttonGroup\">\n\t\t\t<div id=\"acceptAllButton\" class=\"btn_blue_steamui btn_medium replyButton\"><span>Accepter alle<\/span><\/div>\n\t\t\t<div id=\"rejectAllButton\" class=\"btn_grey_steamui btn_medium replyButton\"><span>Afvis alle<\/span><\/div>\n\t\t<\/div>\n\t<\/div>\n<\/div>\n" );
	...
	.fail( function( jqxhr ) {
		...
		switch ( responseJSON.success )
		{
			case 21:
				...
				break;
			case 24:
				ShowAlertDialog( 'Fejl',
					'Din konto opfylder ikke kravene for at bruge denne funktion. <a class="whiteLink" href="https://help.steampowered.com/da/wizard/HelpWithLimitedAccount" target="_blank" rel="noreferrer">Besøg Steam Support</a> for mere information.'
				);
				break;
			case 15:
				ShowAlertDialog( 'Fejl', 'Du har ikke tilladelse til at gennemføre den handling.' );
				break;
			default:
				ShowAlertDialog( 'Fejl', 'Der opstod en fejl under behandlingen af din anmodning: ' + responseJSON.success );
				break;
		}
	} );
	return false;
...
CAjaxInfiniteScrollingControls.prototype.RestoreScrollTop = function( bForce )
{
	...
	if ( scrollTopPrevious )
	{
		...
		else
		{
			...
			{
				this.m_LoadingDialog = ShowBlockingWaitDialog( 'Vent venligst', 'Sender dig tilbage til hvor du sidst var på denne side...' );
			}
			window.scrollTo( 0, scrollTopPrevious );
		}
	}
...
function LockFamilyView( bStore )
{
	...
	ShowConfirmDialog( 'Vend tilbage til familievisning',
		'Er du sikker på, at du vil vende tilbage til familievisning?',
		'Vend tilbage til familievisning'
	).done( function() {
		ShowBlockingWaitDialog( 'Vend tilbage til familievisning' );
			...
			if ( typeof rgSuggestions[i][1] !== 'undefined' )
			{
				switch ( parseInt( rgSuggestions[i][1] ) )
				{
					case 1:
						...
						suggestionText = '[Spil] ' + suggestionText;
						break;
					case 2:
						suggestionText = '[Applikation] ' + suggestionText;
						break;
					case 4:
						suggestionText = '[Værktøj] ' + suggestionText;
						break;
					case 8:
						...
						break;
					case 16:
						suggestionText = '[Medier] ' + suggestionText;
						break;
					case 32:
						resultClass += ' app_DLC';
...
{
	var waitDialog = ShowBlockingWaitDialog( 'Produkteksempler', 'Vent, mens vi finder nogle produkteksempler...' );
	...
	$J.get( 'https://store.steampowered.com/search/results/',
		...
		{
			content.append( $J( "<div>", { class: "no_items", text: 'Ingen produkter fundet' } ) );
		}
