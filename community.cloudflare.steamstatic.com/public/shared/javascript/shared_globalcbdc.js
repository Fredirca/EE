...
{
	ShowConfirmDialog( 'Steam yüklü mü?', 'Makinenizde Steam\'in çalıştığını tespit edemedik. İnternet sohbetini başlatmak ister misiniz?',
		'İnternet sohbetini kullan' , null, 'Steam\'i yükle' ).done( function( choice ) {
			if ( choice == 'OK' )
				fnLaunchWebchat();
			else
...
function InitCookiePreferencesPopup()
{
	...
	if ( $popupDialog.length == 0 )
	{
		...
		var $CPopupContent = $J( "<style>\n.replyButton {\n\twidth: 100%;\n    text-align: center;\n    margin-bottom: 4px;\n}\n\n.buttonGroup {\n\tflex: 18%;\n\tmargin-left: 20px;\n\tmargin-right: 0px;\n}\n.cookieMessage {\n\tflex: 85%;\n\tmargin: auto;\n}\n.popupTextTitle {\n\tpadding-bottom: 10px;\n    font-size: 13px;\n    line-height: 17px;\n    color: #c6d4df;\n}\n.popupTextTitle a {\n    text-decoration: underline;\n}\n.cookiepreferences_popup {\n\tdisplay: none;\n\tposition: fixed;\n\tbottom: 0;\n\twidth: 100%;\n\tz-index: 2000;\n\tpadding-top: 10px;\n}\n.cookiepreferences_popup_content {\n\tdisplay: flex;\n    box-sizing: border-box;\n\twidth: 90%;\n\tmargin: auto;\n\tmargin-bottom: 20px;\n\tpadding: 16px 16px 10px 16px;\n    max-width: 980px;\n\tbackground: linear-gradient(90.85deg, #333840 0.58%, #25282E 74.92%);\n\tbox-shadow: 0px 0px 10px #000000;\n    border-left: 2px solid #00CCFF;\n}\n@media all and (max-width: 910px) {\n    body.responsive_page .cookiepreferences_popup_content {\n        flex-direction: column;\n    }\n    body.responsive_page .cookiepreferences_popup_content .cookieMessage {\n        margin-bottom: 20px;\n    }\n    body.responsive_page .cookiepreferences_popup_content .buttonGroup {\n        flex-direction: row;\n        margin-left: 0px;\n    }\n    body.responsive_page .cookiepreferences_popup_content .buttonGroup .replyButton {\n        width: unset;\n    }\n}\n<\/style>\n\n<div id=\"cookiePrefPopup\" class=\"cookiepreferences_popup\">\n\t<div class=\"cookiepreferences_popup_content\">\n\t\t<div class=\"cookieMessage\">\n\t\t\t<div class=\"popupTextTitle\">Sizin i\u00e7in \u00f6zelle\u015ftirilmi\u015f i\u00e7erik olu\u015fturmak ve site trafi\u011fini analiz etmek i\u00e7in iste\u011fe ba\u011fl\u0131 \u00e7erezleri kullanabilir miyiz?<\/div>\n\t\t\t<div class=\"popupTextTitle\">\u00c7ok fazla \u00e7erez kullanm\u0131yoruz. Bu \u00e7erezlerin tamam\u0131n\u0131 istedi\u011finiz zaman <a href=\"https:\/\/store.steampowered.com\/account\/cookiepreferences\">\u00c7erez Ayarlar\u0131 sayfam\u0131zdan<\/a> g\u00f6rebilir ve y\u00f6netebilirsiniz. \"T\u00fcm\u00fcn\u00fc Kabul Et\" se\u00e7ene\u011fine t\u0131klarsan\u0131z Steam internet sitelerinde \u00e7erezlerin kullan\u0131m\u0131na izin vermi\u015f olursunuz. Kulland\u0131\u011f\u0131m\u0131z \u00e7erezlerle ilgili daha fazla bilgiyi <a href=\"https:\/\/store.steampowered.com\/privacy_agreement\">Gizlilik Politikam\u0131zda<\/a> bulabilirsiniz.<\/div>\n\t\t<\/div>\n\t\t<div class=\"buttonGroup\">\n\t\t\t<div id=\"acceptAllButton\" class=\"btn_blue_steamui btn_medium replyButton\"><span>T\u00fcm\u00fcn\u00fc Kabul Et<\/span><\/div>\n\t\t\t<div id=\"rejectAllButton\" class=\"btn_grey_steamui btn_medium replyButton\"><span>T\u00fcm\u00fcn\u00fc Reddet<\/span><\/div>\n\t\t<\/div>\n\t<\/div>\n<\/div>\n" );
...
function RateAnnouncement( rateURL, gid, bVoteUp, clanID )
{
	...
	.fail( function( jqxhr ) {
		...
		{
			case 21:
				ShowAlertDialog( 'Hata', 'Bu işlemi gerçekleştirmek için giriş yapmış olmalısınız.' );
				break;
			case 24:
				ShowAlertDialog( 'Hata',
					'Hesabınız, bu özelliği kullanmak için gerekli olan gereklilikleri karşılamamaktadır. Daha fazla bilgi için <a class="whiteLink" href="https://help.steampowered.com/tr/wizard/HelpWithLimitedAccount" target="_blank" rel="noreferrer">Steam Desteği ziyaret edin</a>.'
				);
				break;
			case 15:
				ShowAlertDialog( 'Hata', 'Bu eylemi gerçekleştirebilmek için gerekli yetkiye sahip değilsiniz.' );
				break;
			default:
				ShowAlertDialog( 'Hata', 'İşleminiz gerçekleştirirken bir hata ile karşılaşıldı:' + responseJSON.success );
				break;
		}
	} );
	return false;
...
CAjaxInfiniteScrollingControls.prototype.RestoreScrollTop = function( bForce )
{
	...
	if ( scrollTopPrevious )
	{
		...
		else
		{
			...
			{
				this.m_LoadingDialog = ShowBlockingWaitDialog( 'Lütfen Bekleyin', 'Sayfada bulunduğunuz son yere dönülüyor...' );
			}
			window.scrollTo( 0, scrollTopPrevious );
		}
	}
...
function LockFamilyView( bStore )
{
	...
	ShowConfirmDialog( 'Aile Görünümüne geri dön',
		'Aile Görünümüne dönmek istediğinize emin misiniz?',
		'Aile Görünümüne geri dön'
	).done( function() {
		ShowBlockingWaitDialog( 'Aile Görünümüne geri dön' );
			...
			if ( typeof rgSuggestions[i][1] !== 'undefined' )
			{
				switch ( parseInt( rgSuggestions[i][1] ) )
				{
					case 1:
						...
						suggestionText = '[Oyun] ' + suggestionText;
						break;
					case 2:
						suggestionText = '[Uygulama] ' + suggestionText;
						break;
					case 4:
						suggestionText = '[Araç] ' + suggestionText;
						break;
					case 8:
						...
						break;
					case 16:
						suggestionText = '[Medya] ' + suggestionText;
						break;
					case 32:
						resultClass += ' app_DLC';
						...
						break;
					case 256:
						suggestionText = '[Yapılandırma] ' + suggestionText;
						break;
					case 2048:
					...
					case 8192:
						...
						suggestionText = '[Müzik] ' + suggestionText;
						break;
					case 65536:
...
{
	var waitDialog = ShowBlockingWaitDialog( 'Örnek Ürünler', 'Örnek ürünler bulunurken lütfen biraz bekleyin...' );
	...
	$J.get( 'https://store.steampowered.com/search/results/',
		...
		{
			content.append( $J( "<div>", { class: "no_items", text: 'Ürün Bulunamadı' } ) );
		}

		var dialog = ShowAlertDialog( 'Örnek Ürünler', content );
	} );
}
