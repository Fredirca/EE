...
CLoginPromptManager.prototype.DoLogin = function()
{
	...
	$J.post( this.m_strBaseURL + 'getrsakey/', this.GetParameters( { username: username } ) )
		...
		.fail( function () {
			ShowAlertDialog( 'ข้อผิดพลาด', 'ตรวจพบปัญหาในการติดต่อสื่อสารกับเซิร์ฟเวอร์ Steam โปรดลองใหม่อีกครั้งภายหลัง' );
...
CLoginPromptManager.prototype.OnRSAKeyResponse = function( results )
{
	...
	else
	{
		if ( results.message )
		{
			ShowAlertDialog( 'ข้อผิดพลาด', results.message );
		}
		else
		{
			ShowAlertDialog( 'ข้อผิดพลาด', 'ตรวจพบปัญหาในการติดต่อสื่อสารกับเซิร์ฟเวอร์ Steam โปรดลองใหม่อีกครั้งภายหลัง' );
...
CLoginPromptManager.prototype.StartTwoFactorAuthProcess = function()
{
	...
	var _this = this;
	this.m_TwoFactorModal = ShowDialog( 'การยืนยันตัวตน Steam Guard แบบพกพา', this.m_$ModalTwoFactor.show() )
