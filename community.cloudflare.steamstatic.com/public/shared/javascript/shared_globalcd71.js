...
{
	ShowConfirmDialog( '¿Tienes Steam?', 'Parece que Steam no se está ejecutando en tu equipo. ¿Te gustaría iniciar el web chat?',
		'Usar web chat' , null, 'Consigue Steam' ).done( function( choice ) {
			if ( choice == 'OK' )
				fnLaunchWebchat();
			else
		...
		switch ( responseJSON.success )
		{
			...
			case 24:
				ShowAlertDialog( 'Error',
					'Tu cuenta no cumple los requisitos necesarios para utilizar esta función. <a class="whiteLink" href="https://help.steampowered.com/es-419/wizard/HelpWithLimitedAccount" target="_blank" rel="noreferrer">Visita el Soporte de Steam</a> para más información.'
				);
				break;
			case 15:
				...
				break;
			default:
				ShowAlertDialog( 'Error', 'Se produjo un error al procesar tu solicitud: ' + responseJSON.success );
				break;
		}
	} );
	return false;
