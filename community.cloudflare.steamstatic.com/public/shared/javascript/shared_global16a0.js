...
{
	ShowConfirmDialog( 'Har du Steam?', 'Vi fant ikke Steam kjørende på din maskin. Vil du åpne nettsamtalen?',
		'Bruk nettsamtale' , null, 'Skaff deg Steam' ).done( function( choice ) {
			if ( choice == 'OK' )
				fnLaunchWebchat();
			else
...
function InitCookiePreferencesPopup()
{
	...
	if ( $popupDialog.length == 0 )
	{
		...
		var $CPopupContent = $J( "<style>\n.replyButton {\n\twidth: 100%;\n    text-align: center;\n    margin-bottom: 4px;\n}\n\n.buttonGroup {\n\tflex: 18%;\n\tmargin-left: 20px;\n\tmargin-right: 0px;\n}\n.cookieMessage {\n\tflex: 85%;\n\tmargin: auto;\n}\n.popupTextTitle {\n\tpadding-bottom: 10px;\n    font-size: 13px;\n    line-height: 17px;\n    color: #c6d4df;\n}\n.popupTextTitle a {\n    text-decoration: underline;\n}\n.cookiepreferences_popup {\n\tdisplay: none;\n\tposition: fixed;\n\tbottom: 0;\n\twidth: 100%;\n\tz-index: 2000;\n\tpadding-top: 10px;\n}\n.cookiepreferences_popup_content {\n\tdisplay: flex;\n    box-sizing: border-box;\n\twidth: 90%;\n\tmargin: auto;\n\tmargin-bottom: 20px;\n\tpadding: 16px 16px 10px 16px;\n    max-width: 980px;\n\tbackground: linear-gradient(90.85deg, #333840 0.58%, #25282E 74.92%);\n\tbox-shadow: 0px 0px 10px #000000;\n    border-left: 2px solid #00CCFF;\n}\n@media all and (max-width: 910px) {\n    body.responsive_page .cookiepreferences_popup_content {\n        flex-direction: column;\n    }\n    body.responsive_page .cookiepreferences_popup_content .cookieMessage {\n        margin-bottom: 20px;\n    }\n    body.responsive_page .cookiepreferences_popup_content .buttonGroup {\n        flex-direction: row;\n        margin-left: 0px;\n    }\n    body.responsive_page .cookiepreferences_popup_content .buttonGroup .replyButton {\n        width: unset;\n    }\n}\n<\/style>\n\n<div id=\"cookiePrefPopup\" class=\"cookiepreferences_popup\">\n\t<div class=\"cookiepreferences_popup_content\">\n\t\t<div class=\"cookieMessage\">\n\t\t\t<div class=\"popupTextTitle\">Er det greit hvis vi bruker valgfrie informasjonskapsler for \u00e5 gi deg personlig tilpasset innhold og analysere trafikk til sider?<\/div>\n\t\t\t<div class=\"popupTextTitle\">Vi bruker ikke mange informasjonskapsler. Du kan se og behandle dem n\u00e5r som helst i <a href=\"https:\/\/store.steampowered.com\/account\/cookiepreferences\">informasjonskapslenes innstillinger<\/a>. Hvis du trykker p\u00e5 \u00abGodta alle\u00bb, samtykker du til bruk av informasjonskapsler p\u00e5 Steams nettsider. Finn ut mer om informasjonskapslene i v\u00e5re <a href=\"https:\/\/store.steampowered.com\/privacy_agreement\">retningslinjer for personvern<\/a>.<\/div>\n\t\t<\/div>\n\t\t<div class=\"buttonGroup\">\n\t\t\t<div id=\"acceptAllButton\" class=\"btn_blue_steamui btn_medium replyButton\"><span>Godta alle<\/span><\/div>\n\t\t\t<div id=\"rejectAllButton\" class=\"btn_grey_steamui btn_medium replyButton\"><span>Avvis alle<\/span><\/div>\n\t\t<\/div>\n\t<\/div>\n<\/div>\n" );
	...
	.fail( function( jqxhr ) {
		...
		switch ( responseJSON.success )
		{
			case 21:
				...
				break;
			case 24:
				ShowAlertDialog( 'Feil',
					'Kontoen din oppfyller ikke kravene for å bruke denne funksjonen. <a class="whiteLink" href="https://help.steampowered.com/no/wizard/HelpWithLimitedAccount" target="_blank" rel="noreferrer">Besøk Steams kundestøtte</a> for mer informasjon.'
				);
				break;
			case 15:
				ShowAlertDialog( 'Feil', 'Du har ikke tillatelse til å utføre den handlingen.' );
				break;
			default:
				ShowAlertDialog( 'Feil', 'Det oppstod en feil under behandling av forespørselen din: ' + responseJSON.success );
				break;
		}
	} );
	return false;
...
CAjaxInfiniteScrollingControls.prototype.RestoreScrollTop = function( bForce )
{
	...
	if ( scrollTopPrevious )
	{
		...
		else
		{
			...
			{
				this.m_LoadingDialog = ShowBlockingWaitDialog( 'Vent litt', 'Går tilbake til der du sist var på denne siden …' );
			}
			window.scrollTo( 0, scrollTopPrevious );
		}
	}
...
function LockFamilyView( bStore )
{
	...
	ShowConfirmDialog( 'Tilbake til familievisning',
		'Er du sikker på at du vil gå tilbake til familievisning?',
		'Tilbake til familievisning'
	).done( function() {
		ShowBlockingWaitDialog( 'Tilbake til familievisning' );
			...
			if ( typeof rgSuggestions[i][1] !== 'undefined' )
			{
				switch ( parseInt( rgSuggestions[i][1] ) )
				{
					case 1:
						...
						suggestionText = '[Spill] ' + suggestionText;
						break;
					case 2:
						suggestionText = '[Applikasjon] ' + suggestionText;
						break;
					case 4:
						suggestionText = '[Verktøy] ' + suggestionText;
						break;
					case 8:
					...
					case 32:
						resultClass += ' app_DLC';
						suggestionText = '[Nedlastbart innhold] ' + suggestionText;
						break;
					case 256:
						suggestionText = '[Konfigurasjon] ' + suggestionText;
						break;
					case 2048:
					...
					case 8192:
						...
						suggestionText = '[Musikk] ' + suggestionText;
						break;
					case 65536:
...
{
	var waitDialog = ShowBlockingWaitDialog( 'Produkteksempler', 'Vent litt mens vi finner noen produkteksempler …' );
	...
	$J.get( 'https://store.steampowered.com/search/results/',
		...
		{
			content.append( $J( "<div>", { class: "no_items", text: 'Fant ingen produkter' } ) );
		}

		var dialog = ShowAlertDialog( 'Produkteksempler', content );
	} );
}
