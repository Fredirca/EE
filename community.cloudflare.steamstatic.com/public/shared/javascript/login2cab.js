...
CLoginPromptManager.prototype.OnRSAKeyResponse = function( results )
{
	...
	else
	{
		if ( results.message )
		{
			ShowAlertDialog( 'エラー', results.message );
		}
		else
		{
			ShowAlertDialog( 'エラー', 'Steam サーバーとの通信中に問題が発生しました。 後でもう一度お試しください。' );
...
CLoginPromptManager.prototype.StartEmailAuthProcess = function()
{
	...
	var _this = this;
	this.m_EmailAuthModal = ShowDialog( 'Steamガード', this.m_$ModalAuthCode.show() )
		.always( function() {
...
CLoginPromptManager.prototype.StartTwoFactorAuthProcess = function()
{
	...
	var _this = this;
	this.m_TwoFactorModal = ShowDialog( 'Steamガードモバイル認証', this.m_$ModalTwoFactor.show() )
