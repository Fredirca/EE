...
{
	ShowConfirmDialog( 'Steam installiert?', 'Steam scheint auf Ihrem Gerät nicht aktiv zu sein. Möchten Sie den Webchat starten?',
		'Webchat verwenden' , null, 'Steam herunterladen' ).done( function( choice ) {
			if ( choice == 'OK' )
				fnLaunchWebchat();
			else
...
function InitCookiePreferencesPopup()
{
	...
	if ( $popupDialog.length == 0 )
	{
		...
		var $CPopupContent = $J( "<style>\n.replyButton {\n\twidth: 100%;\n    text-align: center;\n    margin-bottom: 4px;\n}\n\n.buttonGroup {\n\tflex: 18%;\n\tmargin-left: 20px;\n\tmargin-right: 0px;\n}\n.cookieMessage {\n\tflex: 85%;\n\tmargin: auto;\n}\n.popupTextTitle {\n\tpadding-bottom: 10px;\n    font-size: 13px;\n    line-height: 17px;\n    color: #c6d4df;\n}\n.popupTextTitle a {\n    text-decoration: underline;\n}\n.cookiepreferences_popup {\n\tdisplay: none;\n\tposition: fixed;\n\tbottom: 0;\n\twidth: 100%;\n\tz-index: 2000;\n\tpadding-top: 10px;\n}\n.cookiepreferences_popup_content {\n\tdisplay: flex;\n    box-sizing: border-box;\n\twidth: 90%;\n\tmargin: auto;\n\tmargin-bottom: 20px;\n\tpadding: 16px 16px 10px 16px;\n    max-width: 980px;\n\tbackground: linear-gradient(90.85deg, #333840 0.58%, #25282E 74.92%);\n\tbox-shadow: 0px 0px 10px #000000;\n    border-left: 2px solid #00CCFF;\n}\n@media all and (max-width: 910px) {\n    body.responsive_page .cookiepreferences_popup_content {\n        flex-direction: column;\n    }\n    body.responsive_page .cookiepreferences_popup_content .cookieMessage {\n        margin-bottom: 20px;\n    }\n    body.responsive_page .cookiepreferences_popup_content .buttonGroup {\n        flex-direction: row;\n        margin-left: 0px;\n    }\n    body.responsive_page .cookiepreferences_popup_content .buttonGroup .replyButton {\n        width: unset;\n    }\n}\n<\/style>\n\n<div id=\"cookiePrefPopup\" class=\"cookiepreferences_popup\">\n\t<div class=\"cookiepreferences_popup_content\">\n\t\t<div class=\"cookieMessage\">\n\t\t\t<div class=\"popupTextTitle\">Sind Sie damit einverstanden, dass wir optionale Cookies verwenden, um die Inhalte f\u00fcr Sie zu personalisieren und den Website-Datenverkehr zu analysieren?<\/div>\n\t\t\t<div class=\"popupTextTitle\">Wir verwenden nicht viele Cookies. Sie k\u00f6nnen diese jederzeit in unseren <a href=\"https:\/\/store.steampowered.com\/account\/cookiepreferences\">Cookie-Einstellungen<\/a> einsehen und verwalten. Wenn Sie auf \u201eAlle akzeptieren\u201c klicken, stimmen Sie der allgemeinen Verwendung von Cookies auf Steam-Websites zu. Weitere Informationen zu Cookies finden Sie in unseren <a href=\"https:\/\/store.steampowered.com\/privacy_agreement\">Datenschutzrichtlinien<\/a>.<\/div>\n\t\t<\/div>\n\t\t<div class=\"buttonGroup\">\n\t\t\t<div id=\"acceptAllButton\" class=\"btn_blue_steamui btn_medium replyButton\"><span>Alle akzeptieren<\/span><\/div>\n\t\t\t<div id=\"rejectAllButton\" class=\"btn_grey_steamui btn_medium replyButton\"><span>Alle ablehnen<\/span><\/div>\n\t\t<\/div>\n\t<\/div>\n<\/div>\n" );
	...
	.fail( function( jqxhr ) {
		...
		switch ( responseJSON.success )
		{
			case 21:
				...
				break;
			case 24:
				ShowAlertDialog( 'Fehler',
					'Ihr Account erfüllt nicht die Voraussetzungen, um diese Funktion zu nutzen. <a class="whiteLink" href="https://help.steampowered.com/de/wizard/HelpWithLimitedAccount" target="_blank" rel="noreferrer">Besuchen Sie den Steam-Support</a>, um weitere Informationen zu erhalten.'
				);
				break;
			case 15:
				ShowAlertDialog( 'Fehler', 'Sie sind nicht berechtigt, diese Aktion auszuführen.' );
				break;
			default:
				ShowAlertDialog( 'Fehler', 'Beim Ausführen Ihrer Anfrage ist ein Fehler aufgetreten:' + responseJSON.success );
				break;
		}
	} );
	return false;
...
CAjaxInfiniteScrollingControls.prototype.RestoreScrollTop = function( bForce )
{
	...
	if ( scrollTopPrevious )
	{
		...
		else
		{
			...
			{
				this.m_LoadingDialog = ShowBlockingWaitDialog( 'Bitte warten', 'Zurück dorthin, wo Sie sich auf dieser Seite zuletzt befunden haben …' );
			}
			window.scrollTo( 0, scrollTopPrevious );
		}
	}
...
function LockFamilyView( bStore )
{
	...
	ShowConfirmDialog( 'Zurück zur Familienansicht',
		'Sind Sie sicher, dass Sie zur Familienansicht zurückkehren möchten?',
		'Zurück zur Familienansicht'
	).done( function() {
		ShowBlockingWaitDialog( 'Zurück zur Familienansicht' );
			...
			if ( typeof rgSuggestions[i][1] !== 'undefined' )
			{
				switch ( parseInt( rgSuggestions[i][1] ) )
				{
					case 1:
						...
						suggestionText = '[Spiel] ' + suggestionText;
						break;
					case 2:
						suggestionText = '[Anwendung] ' + suggestionText;
						break;
					case 4:
						suggestionText = '[Werkzeug] ' + suggestionText;
						break;
					case 8:
						...
						break;
					case 16:
						suggestionText = '[Medien] ' + suggestionText;
						break;
					case 32:
						resultClass += ' app_DLC';
						suggestionText = '[Zusatzinhalt] ' + suggestionText;
						break;
					case 256:
						suggestionText = '[Konfiguration] ' + suggestionText;
						break;
					case 2048:
...
{
	var waitDialog = ShowBlockingWaitDialog( 'Beispielprodukte', 'Bitte warten Sie, während wir Beispielprodukte finden …' );
	...
	$J.get( 'https://store.steampowered.com/search/results/',
		...
		{
			content.append( $J( "<div>", { class: "no_items", text: 'Keine Produkte gefunden' } ) );
		}

		var dialog = ShowAlertDialog( 'Beispielprodukte', content );
	} );
}
