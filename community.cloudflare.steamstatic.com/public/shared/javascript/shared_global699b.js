...
{
	ShowConfirmDialog( 'Đã có Steam?', 'Chúng tôi không tìm thấy Steam đang chạy trên máy của bạn. Bạn có muốn mở giao diện trò chuyện dạng web không?',
		'Trò chuyện qua web' , null, 'Tải Steam' ).done( function( choice ) {
			if ( choice == 'OK' )
				fnLaunchWebchat();
			else
...
function InitCookiePreferencesPopup()
{
	...
	if ( $popupDialog.length == 0 )
	{
		...
		var $CPopupContent = $J( "<style>\n.replyButton {\n\twidth: 100%;\n    text-align: center;\n    margin-bottom: 4px;\n}\n\n.buttonGroup {\n\tflex: 18%;\n\tmargin-left: 20px;\n\tmargin-right: 0px;\n}\n.cookieMessage {\n\tflex: 85%;\n\tmargin: auto;\n}\n.popupTextTitle {\n\tpadding-bottom: 10px;\n    font-size: 13px;\n    line-height: 17px;\n    color: #c6d4df;\n}\n.popupTextTitle a {\n    text-decoration: underline;\n}\n.cookiepreferences_popup {\n\tdisplay: none;\n\tposition: fixed;\n\tbottom: 0;\n\twidth: 100%;\n\tz-index: 2000;\n\tpadding-top: 10px;\n}\n.cookiepreferences_popup_content {\n\tdisplay: flex;\n    box-sizing: border-box;\n\twidth: 90%;\n\tmargin: auto;\n\tmargin-bottom: 20px;\n\tpadding: 16px 16px 10px 16px;\n    max-width: 980px;\n\tbackground: linear-gradient(90.85deg, #333840 0.58%, #25282E 74.92%);\n\tbox-shadow: 0px 0px 10px #000000;\n    border-left: 2px solid #00CCFF;\n}\n@media all and (max-width: 910px) {\n    body.responsive_page .cookiepreferences_popup_content {\n        flex-direction: column;\n    }\n    body.responsive_page .cookiepreferences_popup_content .cookieMessage {\n        margin-bottom: 20px;\n    }\n    body.responsive_page .cookiepreferences_popup_content .buttonGroup {\n        flex-direction: row;\n        margin-left: 0px;\n    }\n    body.responsive_page .cookiepreferences_popup_content .buttonGroup .replyButton {\n        width: unset;\n    }\n}\n<\/style>\n\n<div id=\"cookiePrefPopup\" class=\"cookiepreferences_popup\">\n\t<div class=\"cookiepreferences_popup_content\">\n\t\t<div class=\"cookieMessage\">\n\t\t\t<div class=\"popupTextTitle\">B\u1ea1n c\u00f3 phi\u1ec1n kh\u00f4ng n\u1ebfu ch\u00fang t\u00f4i d\u00f9ng c\u00e1c cookie b\u1ed5 sung \u0111\u1ec3 mang t\u1edbi tr\u1ea3i nghi\u1ec7m c\u00e1 nh\u00e2n h\u00f3a d\u00e0nh ri\u00eang cho b\u1ea1n v\u00e0 ph\u00e2n t\u00edch l\u01b0u l\u01b0\u1ee3ng truy c\u1eadp trang?<\/div>\n\t\t\t<div class=\"popupTextTitle\">Ch\u00fang t\u00f4i kh\u00f4ng d\u00f9ng nhi\u1ec1u cookie; b\u1ea1n c\u00f3 th\u1ec3 xem v\u00e0 qu\u1ea3n l\u00fd ch\u00fang b\u1ea5t c\u1ee9 l\u00fac n\u00e0o t\u1ea1i <a href=\"https:\/\/store.steampowered.com\/account\/cookiepreferences\">trang thi\u1ebft l\u1eadp cookie<\/a>. N\u1ebfu b\u1ea1n nh\u1ea5p 'Ch\u1ea5p nh\u1eadn t\u1ea5t c\u1ea3', ngh\u0129a l\u00e0 b\u1ea1n \u0111\u1ed3ng \u00fd s\u1eed d\u1ee5ng cookie tr\u00ean trang web Steam. T\u00ecm hi\u1ec3u th\u00eam v\u1ec1 cookie trong <a href=\"https:\/\/store.steampowered.com\/privacy_agreement\">ch\u00ednh s\u00e1ch quy\u1ec1n ri\u00eang t\u01b0<\/a>.<\/div>\n\t\t<\/div>\n\t\t<div class=\"buttonGroup\">\n\t\t\t<div id=\"acceptAllButton\" class=\"btn_blue_steamui btn_medium replyButton\"><span>Ch\u1ea5p nh\u1eadn t\u1ea5t c\u1ea3<\/span><\/div>\n\t\t\t<div id=\"rejectAllButton\" class=\"btn_grey_steamui btn_medium replyButton\"><span>T\u1eeb ch\u1ed1i t\u1ea5t c\u1ea3<\/span><\/div>\n\t\t<\/div>\n\t<\/div>\n<\/div>\n" );
...
function RateAnnouncement( rateURL, gid, bVoteUp, clanID )
{
	...
	.fail( function( jqxhr ) {
		...
		switch ( responseJSON.success )
		{
			...
			case 24:
				ShowAlertDialog( 'Lỗi',
					'Tài khoản của bạn không đáp ứng đủ yêu cầu để dùng tính năng này. <a class="whiteLink" href="https://help.steampowered.com/vi/wizard/HelpWithLimitedAccount" target="_blank" rel="noreferrer">Ghé thăm trang hỗ trợ Steam</a> để biết thêm thông tin.'
				);
				break;
			case 15:
				ShowAlertDialog( 'Lỗi', 'Bạn không có quyền thực thi hành động đó.' );
				break;
			default:
				ShowAlertDialog( 'Lỗi', 'Đã có lỗi xảy ra trong quá trình xử lý yêu cầu của bạn:' + responseJSON.success );
				break;
		}
	} );
	return false;
...
CAjaxInfiniteScrollingControls.prototype.RestoreScrollTop = function( bForce )
{
	...
	if ( scrollTopPrevious )
	{
		...
		else
		{
			...
			{
				this.m_LoadingDialog = ShowBlockingWaitDialog( 'Vui lòng đợi', 'Quay lại điểm gần nhất bạn đã ở trên trang này...' );
			}
			window.scrollTo( 0, scrollTopPrevious );
		}
	}
...
function LockFamilyView( bStore )
{
	...
	ShowConfirmDialog( 'Quay lại chế độ gia đình',
		'Bạn có thực sự muốn quay lại chế độ gia đình?',
		'Quay lại chế độ gia đình'
	).done( function() {
		ShowBlockingWaitDialog( 'Quay lại chế độ gia đình' );
			...
			if ( typeof rgSuggestions[i][1] !== 'undefined' )
			{
				switch ( parseInt( rgSuggestions[i][1] ) )
				{
					case 1:
						...
						suggestionText = '[Trò chơi] ' + suggestionText;
						break;
					case 2:
						suggestionText = '[Ứng dụng] ' + suggestionText;
						break;
					case 4:
						suggestionText = '[Công cụ] ' + suggestionText;
						break;
					case 8:
					...
					case 32:
						...
						break;
					case 256:
						suggestionText = '[Thiết lập] ' + suggestionText;
						break;
					case 2048:
					...
					case 8192:
						...
						suggestionText = '[Nhạc] ' + suggestionText;
						break;
					case 65536:
...
{
	var waitDialog = ShowBlockingWaitDialog( 'Sản phẩm ví dụ', 'Xin hãy vui lòng chờ trong khi chúng tôi tìm cho bạn một vài sản phẩm mẫu...' );
	...
	$J.get( 'https://store.steampowered.com/search/results/',
		...
		{
			content.append( $J( "<div>", { class: "no_items", text: 'Không tìm thấy sản phẩm' } ) );
		}

		var dialog = ShowAlertDialog( 'Sản phẩm ví dụ', content );
	} );
}
