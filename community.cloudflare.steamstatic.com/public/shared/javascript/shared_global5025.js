...
{
	ShowConfirmDialog( 'Van Steamed?', 'Nem találtunk futó Steamet a gépeden. Szeretnél web-csevegést indítani?',
		'Web-csevegés használata' , null, 'A Steam beszerzése' ).done( function( choice ) {
			if ( choice == 'OK' )
				fnLaunchWebchat();
			else
...
function InitCookiePreferencesPopup()
{
	...
	if ( $popupDialog.length == 0 )
	{
		...
		var $CPopupContent = $J( "<style>\n.replyButton {\n\twidth: 100%;\n    text-align: center;\n    margin-bottom: 4px;\n}\n\n.buttonGroup {\n\tflex: 18%;\n\tmargin-left: 20px;\n\tmargin-right: 0px;\n}\n.cookieMessage {\n\tflex: 85%;\n\tmargin: auto;\n}\n.popupTextTitle {\n\tpadding-bottom: 10px;\n    font-size: 13px;\n    line-height: 17px;\n    color: #c6d4df;\n}\n.popupTextTitle a {\n    text-decoration: underline;\n}\n.cookiepreferences_popup {\n\tdisplay: none;\n\tposition: fixed;\n\tbottom: 0;\n\twidth: 100%;\n\tz-index: 2000;\n\tpadding-top: 10px;\n}\n.cookiepreferences_popup_content {\n\tdisplay: flex;\n    box-sizing: border-box;\n\twidth: 90%;\n\tmargin: auto;\n\tmargin-bottom: 20px;\n\tpadding: 16px 16px 10px 16px;\n    max-width: 980px;\n\tbackground: linear-gradient(90.85deg, #333840 0.58%, #25282E 74.92%);\n\tbox-shadow: 0px 0px 10px #000000;\n    border-left: 2px solid #00CCFF;\n}\n@media all and (max-width: 910px) {\n    body.responsive_page .cookiepreferences_popup_content {\n        flex-direction: column;\n    }\n    body.responsive_page .cookiepreferences_popup_content .cookieMessage {\n        margin-bottom: 20px;\n    }\n    body.responsive_page .cookiepreferences_popup_content .buttonGroup {\n        flex-direction: row;\n        margin-left: 0px;\n    }\n    body.responsive_page .cookiepreferences_popup_content .buttonGroup .replyButton {\n        width: unset;\n    }\n}\n<\/style>\n\n<div id=\"cookiePrefPopup\" class=\"cookiepreferences_popup\">\n\t<div class=\"cookiepreferences_popup_content\">\n\t\t<div class=\"cookieMessage\">\n\t\t\t<div class=\"popupTextTitle\">Megengeded, hogy opcion\u00e1lis s\u00fctiket haszn\u00e1ljunk szem\u00e9lyre szabott tartalom ny\u00fajt\u00e1s\u00e1hoz \u00e9s az oldalforgalom elemz\u00e9s\u00e9hez?<\/div>\n\t\t\t<div class=\"popupTextTitle\">Nem haszn\u00e1lunk sok s\u00fctit; b\u00e1rmikor l\u00e1thatod \u00e9s kezelheted \u0151ket a <a href=\"https:\/\/store.steampowered.com\/account\/cookiepreferences\">S\u00fctibe\u00e1ll\u00edt\u00e1sok oldalunkon<\/a>. Ha az \u201e\u00d6sszes elfogad\u00e1s\u00e1ra\u201d kattintasz, hozz\u00e1j\u00e1rulsz a s\u00fctik haszn\u00e1lat\u00e1hoz a Steam weboldalakon. Tudj meg t\u00f6bbet a s\u00fctikr\u0151l az <a href=\"https:\/\/store.steampowered.com\/privacy_agreement\">adatv\u00e9delmi szab\u00e1lyzatunkban<\/a>.<\/div>\n\t\t<\/div>\n\t\t<div class=\"buttonGroup\">\n\t\t\t<div id=\"acceptAllButton\" class=\"btn_blue_steamui btn_medium replyButton\"><span>\u00d6sszes elfogad\u00e1sa<\/span><\/div>\n\t\t\t<div id=\"rejectAllButton\" class=\"btn_grey_steamui btn_medium replyButton\"><span>\u00d6sszes elutas\u00edt\u00e1sa<\/span><\/div>\n\t\t<\/div>\n\t<\/div>\n<\/div>\n" );
...
function RateAnnouncement( rateURL, gid, bVoteUp, clanID )
{
	...
	.fail( function( jqxhr ) {
		...
		{
			case 21:
				ShowAlertDialog( 'Hiba', 'A művelet végrehajtásához be kell jelentkezned.' );
				break;
			case 24:
				ShowAlertDialog( 'Hiba',
					'Fiókod nem felel meg az e funkció használatához szükséges követelményeknek. További információért <a class="whiteLink" href="https://help.steampowered.com/hu/wizard/HelpWithLimitedAccount" target="_blank" rel="noreferrer">látogasd meg a Steam Támogatást</a>.'
				);
				break;
			case 15:
				ShowAlertDialog( 'Hiba', 'Nincs jogosultságod e művelet végrehajtásához.' );
				break;
			default:
				ShowAlertDialog( 'Hiba', 'Hiba történt kérésed feldolgozásakor: ' + responseJSON.success );
				break;
		}
	} );
	return false;
...
CAjaxInfiniteScrollingControls.prototype.RestoreScrollTop = function( bForce )
{
	...
	if ( scrollTopPrevious )
	{
		...
		else
		{
			...
			{
				this.m_LoadingDialog = ShowBlockingWaitDialog( 'Kérjük, várj', 'Visszatérés oda, ahol legutóbb voltál ezen a lapon...' );
			}
			window.scrollTo( 0, scrollTopPrevious );
		}
	}
...
function LockFamilyView( bStore )
{
	...
	ShowConfirmDialog( 'Visszatérés Családi Nézetbe',
		'Biztosan vissza szeretnél térni Családi Nézetbe?',
		'Visszatérés Családi Nézetbe'
	).done( function() {
		ShowBlockingWaitDialog( 'Visszatérés Családi Nézetbe' );
			...
			if ( typeof rgSuggestions[i][1] !== 'undefined' )
			{
				switch ( parseInt( rgSuggestions[i][1] ) )
				{
					case 1:
						...
						suggestionText = '[Játék] ' + suggestionText;
						break;
					case 2:
						suggestionText = '[Alkalmazás] ' + suggestionText;
						break;
					case 4:
						suggestionText = '[Kellék] ' + suggestionText;
						break;
					case 8:
						resultClass += ' app_Demo';
						suggestionText = '[Demó] ' + suggestionText;
						break;
					case 16:
						suggestionText = '[Média] ' + suggestionText;
						break;
					case 32:
						resultClass += ' app_DLC';
						...
						break;
					case 256:
						suggestionText = '[Konfig] ' + suggestionText;
						break;
					case 2048:
						resultClass += ' app_Movie';
						suggestionText = '[Videó] ' + suggestionText;
						break;
					case 8192:
						resultClass += ' app_Music';
						suggestionText = '[Zene] ' + suggestionText;
						break;
					case 65536:
						resultClass += ' app_Beta';
						suggestionText = '[Béta] ' + suggestionText;
						break;
				}
			}
...
{
	var waitDialog = ShowBlockingWaitDialog( 'Példatermékek', 'Kérjük, várj, míg találunk néhány példaterméket...' );
	...
	$J.get( 'https://store.steampowered.com/search/results/',
		...
		{
			content.append( $J( "<div>", { class: "no_items", text: 'Nem található termék' } ) );
		}

		var dialog = ShowAlertDialog( 'Példatermékek', content );
	} );
}
