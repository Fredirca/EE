...
{
	ShowConfirmDialog( 'Имате ли Steam?', 'Не успяхме да намерим пуснат Steam на машината Ви. Бихте ли искали да пуснете уеб чата?',
		'Използване на уеб чат' , null, 'Вземете Steam' ).done( function( choice ) {
			if ( choice == 'OK' )
				fnLaunchWebchat();
			else
...
function InitCookiePreferencesPopup()
{
	...
	if ( $popupDialog.length == 0 )
	{
		...
		var $CPopupContent = $J( "<style>\n.replyButton {\n\twidth: 100%;\n    text-align: center;\n    margin-bottom: 4px;\n}\n\n.buttonGroup {\n\tflex: 18%;\n\tmargin-left: 20px;\n\tmargin-right: 0px;\n}\n.cookieMessage {\n\tflex: 85%;\n\tmargin: auto;\n}\n.popupTextTitle {\n\tpadding-bottom: 10px;\n    font-size: 13px;\n    line-height: 17px;\n    color: #c6d4df;\n}\n.popupTextTitle a {\n    text-decoration: underline;\n}\n.cookiepreferences_popup {\n\tdisplay: none;\n\tposition: fixed;\n\tbottom: 0;\n\twidth: 100%;\n\tz-index: 2000;\n\tpadding-top: 10px;\n}\n.cookiepreferences_popup_content {\n\tdisplay: flex;\n    box-sizing: border-box;\n\twidth: 90%;\n\tmargin: auto;\n\tmargin-bottom: 20px;\n\tpadding: 16px 16px 10px 16px;\n    max-width: 980px;\n\tbackground: linear-gradient(90.85deg, #333840 0.58%, #25282E 74.92%);\n\tbox-shadow: 0px 0px 10px #000000;\n    border-left: 2px solid #00CCFF;\n}\n@media all and (max-width: 910px) {\n    body.responsive_page .cookiepreferences_popup_content {\n        flex-direction: column;\n    }\n    body.responsive_page .cookiepreferences_popup_content .cookieMessage {\n        margin-bottom: 20px;\n    }\n    body.responsive_page .cookiepreferences_popup_content .buttonGroup {\n        flex-direction: row;\n        margin-left: 0px;\n    }\n    body.responsive_page .cookiepreferences_popup_content .buttonGroup .replyButton {\n        width: unset;\n    }\n}\n<\/style>\n\n<div id=\"cookiePrefPopup\" class=\"cookiepreferences_popup\">\n\t<div class=\"cookiepreferences_popup_content\">\n\t\t<div class=\"cookieMessage\">\n\t\t\t<div class=\"popupTextTitle\">\u0418\u043c\u0430\u0442\u0435 \u043b\u0438 \u043d\u0435\u0449\u043e \u043f\u0440\u043e\u0442\u0438\u0432 \u0434\u0430 \u0438\u0437\u043f\u043e\u043b\u0437\u0432\u0430\u043c\u0435 \u043d\u0435\u0437\u0430\u0434\u044a\u043b\u0436\u0438\u0442\u0435\u043b\u043d\u0438 \u0431\u0438\u0441\u043a\u0432\u0438\u0442\u043a\u0438, \u0437\u0430 \u0434\u0430 \u0412\u0438 \u043f\u0440\u0435\u0434\u043e\u0441\u0442\u0430\u0432\u0438\u043c \u043f\u0435\u0440\u0441\u043e\u043d\u0430\u043b\u0438\u0437\u0438\u0440\u0430\u043d\u043e \u0441\u044a\u0434\u044a\u0440\u0436\u0430\u043d\u0438\u0435 \u0438 \u0434\u0430 \u0430\u043d\u0430\u043b\u0438\u0437\u0438\u0440\u0430\u043c\u0435 \u0442\u0440\u0430\u0444\u0438\u043a\u0430 \u043a\u044a\u043c \u0443\u0435\u0431\u0441\u0430\u0439\u0442\u0430?<\/div>\n\t\t\t<div class=\"popupTextTitle\">\u041d\u0438\u0435 \u043d\u0435 \u0438\u0437\u043f\u043e\u043b\u0437\u0432\u0430\u043c\u0435 \u043c\u043d\u043e\u0433\u043e \u0431\u0438\u0441\u043a\u0432\u0438\u0442\u043a\u0438 \u2014 \u043c\u043e\u0436\u0435\u0442\u0435 \u0434\u0430 \u0433\u0438 \u0432\u0438\u0434\u0438\u0442\u0435 \u0438 \u0443\u043f\u0440\u0430\u0432\u043b\u044f\u0432\u0430\u0442\u0435 \u043f\u043e \u0432\u0441\u044f\u043a\u043e \u0432\u0440\u0435\u043c\u0435 \u0432 \u043d\u0430\u0448\u0430\u0442\u0430 <a href=\"https:\/\/store.steampowered.com\/account\/cookiepreferences\">\u0441\u0442\u0440\u0430\u043d\u0438\u0446\u0430 \u201e\u041d\u0430\u0441\u0442\u0440\u043e\u0439\u043a\u0438 \u043d\u0430 \u0431\u0438\u0441\u043a\u0432\u0438\u0442\u043a\u0438\u0442\u0435\u201c<\/a>. \u0421 \u043a\u043b\u0438\u043a\u0432\u0430\u043d\u0435\u0442\u043e \u0432\u044a\u0440\u0445\u0443 \u201e\u041f\u0440\u0438\u0435\u043c\u0430\u043d\u0435 \u043d\u0430 \u0432\u0441\u0438\u0447\u043a\u0438\u201c \u0412\u0438\u0435 \u0441\u0435 \u0441\u044a\u0433\u043b\u0430\u0441\u044f\u0432\u0430\u0442\u0435 \u0441 \u0443\u043f\u043e\u0442\u0440\u0435\u0431\u0430\u0442\u0430 \u043d\u0430 \u0431\u0438\u0441\u043a\u0432\u0438\u0442\u043a\u0438 \u0432 \u0443\u0435\u0431\u0441\u0430\u0439\u0442\u043e\u0432\u0435\u0442\u0435 \u043d\u0430 Steam. \u041d\u0430\u0443\u0447\u0435\u0442\u0435 \u043e\u0449\u0435 \u0437\u0430 \u0431\u0438\u0441\u043a\u0432\u0438\u0442\u043a\u0438\u0442\u0435 \u043e\u0442 \u043d\u0430\u0448\u0430\u0442\u0430 <a href=\"https:\/\/store.steampowered.com\/privacy_agreement\">\u201e\u0414\u0435\u043a\u043b\u0430\u0440\u0430\u0446\u0438\u044f \u0437\u0430 \u043f\u043e\u0432\u0435\u0440\u0438\u0442\u0435\u043b\u043d\u043e\u0441\u0442\u201c<\/a>.<\/div>\n\t\t<\/div>\n\t\t<div class=\"buttonGroup\">\n\t\t\t<div id=\"acceptAllButton\" class=\"btn_blue_steamui btn_medium replyButton\"><span>\u041f\u0440\u0438\u0435\u043c\u0430\u043d\u0435 \u043d\u0430 \u0432\u0441\u0438\u0447\u043a\u0438<\/span><\/div>\n\t\t\t<div id=\"rejectAllButton\" class=\"btn_grey_steamui btn_medium replyButton\"><span>\u041e\u0442\u0445\u0432\u044a\u0440\u043b\u044f\u043d\u0435 \u043d\u0430 \u0432\u0441\u0438\u0447\u043a\u0438<\/span><\/div>\n\t\t<\/div>\n\t<\/div>\n<\/div>\n" );
	...
	.fail( function( jqxhr ) {
		...
		switch ( responseJSON.success )
		{
			case 21:
				...
				break;
			case 24:
				ShowAlertDialog( 'Грешка',
					'Акаунтът Ви не покрива изискванията за ползване на тази функция. <a class="whiteLink" href="https://help.steampowered.com/bg/wizard/HelpWithLimitedAccount" target="_blank" rel="noreferrer">Посетете Steam поддръжката</a> за още информация.'
				);
				break;
			case 15:
				ShowAlertDialog( 'Грешка', 'Нямате правомощия, за да изпълните това действие.' );
				break;
			default:
				ShowAlertDialog( 'Грешка', 'Натъкнахме се на грешка, докато обработвахме заявката Ви: ' + responseJSON.success );
				break;
		}
	} );
	return false;
...
CAjaxInfiniteScrollingControls.prototype.RestoreScrollTop = function( bForce )
{
	...
	if ( scrollTopPrevious )
	{
		...
		else
		{
			...
			{
				this.m_LoadingDialog = ShowBlockingWaitDialog( 'Моля, изчакайте', 'Връщане към предното място, където сте били на тази страница…' );
			}
			window.scrollTo( 0, scrollTopPrevious );
		}
	}
...
function LockFamilyView( bStore )
{
	...
	ShowConfirmDialog( 'Връщане към „Семеен изглед“',
		'Сигурни ли сте, че искате да се върнете към „Семеен изглед“.',
		'Връщане към „Семеен изглед“'
	).done( function() {
		ShowBlockingWaitDialog( 'Връщане към „Семеен изглед“' );
			...
			if ( typeof rgSuggestions[i][1] !== 'undefined' )
			{
				switch ( parseInt( rgSuggestions[i][1] ) )
				{
					case 1:
						...
						suggestionText = '[Игра] ' + suggestionText;
						break;
					case 2:
						suggestionText = '[Приложение] ' + suggestionText;
						break;
					case 4:
						suggestionText = '[Инструмент] ' + suggestionText;
						break;
					case 8:
						resultClass += ' app_Demo';
						suggestionText = '[Демо] ' + suggestionText;
						break;
					case 16:
						suggestionText = '[Медия] ' + suggestionText;
						break;
					case 32:
						resultClass += ' app_DLC';
						suggestionText = '[Сваляемо съдържание] ' + suggestionText;
						break;
					case 256:
						suggestionText = '[Конфигурация] ' + suggestionText;
						break;
					case 2048:
						resultClass += ' app_Movie';
						suggestionText = '[Видео] ' + suggestionText;
						break;
					case 8192:
...
{
	var waitDialog = ShowBlockingWaitDialog( 'Примерни продукти', 'Моля, изчакайте, докато намерим някакви примерни продукти…' );
	...
	$J.get( 'https://store.steampowered.com/search/results/',
		...
		{
			content.append( $J( "<div>", { class: "no_items", text: 'Няма намерени продукти' } ) );
		}

		var dialog = ShowAlertDialog( 'Примери продукти', content );
	} );
}
