...
function Responsive_BuildChangeLanguageOption( $MenuItem )
{
	$MenuItem.click( function() {
		...
		$SelectBox.append(
			$J('<option/>', {value: "norwegian"} ).text( 'Norsk' )
				...
				$J('<option/>', {value: "schinese"} ).text( '简体中文 (forenklet kinesisk)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "tchinese"} ).text( '繁體中文 (tradisjonell kinesisk)' )
			);
					$SelectBox.append(
				...
				$J('<option/>', {value: "bulgarian"} ).text( 'Български (bulgarsk)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "czech"} ).text( 'Čeština (tsjekkisk)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "danish"} ).text( 'Dansk (dansk)' )
			);
					$SelectBox.append(
				...
				$J('<option/>', {value: "english"} ).text( 'English (engelsk)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "spanish"} ).text( 'Español – España (spansk – Spania)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "latam"} ).text( 'Español – Latinoamérica (spansk – Latin-Amerika)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "greek"} ).text( 'Ελληνικά (gresk)' )
			);
					$SelectBox.append(
				...
				$J('<option/>', {value: "hungarian"} ).text( 'Magyar (ungarsk)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "dutch"} ).text( 'Nederlands (nederlandsk)' )
			);
					$SelectBox.append(
				...
				$J('<option/>', {value: "portuguese"} ).text( 'Português (portugisisk – Portugal)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "brazilian"} ).text( 'Português – Brasil (portugisisk – Brasil)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "romanian"} ).text( 'Română (rumensk)' )
			);
					$SelectBox.append(
		...
		Modal = ShowConfirmDialog( 'Bytt språk', $LanguageForm, 'Bytt språk' ).done( fnChangeLanguage );
		$SelectBox.focus();
	});
}
