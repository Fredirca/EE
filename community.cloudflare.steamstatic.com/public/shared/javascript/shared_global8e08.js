...
{
	ShowConfirmDialog( 'Steam instalado?', 'O Steam não parece estar rodando neste computador. Deseja abrir a conversa no navegador?',
		'Usar o navegador' , null, 'Baixar o Steam' ).done( function( choice ) {
			if ( choice == 'OK' )
				fnLaunchWebchat();
			else
...
function InitCookiePreferencesPopup()
{
	...
	if ( $popupDialog.length == 0 )
	{
		...
		var $CPopupContent = $J( "<style>\n.replyButton {\n\twidth: 100%;\n    text-align: center;\n    margin-bottom: 4px;\n}\n\n.buttonGroup {\n\tflex: 18%;\n\tmargin-left: 20px;\n\tmargin-right: 0px;\n}\n.cookieMessage {\n\tflex: 85%;\n\tmargin: auto;\n}\n.popupTextTitle {\n\tpadding-bottom: 10px;\n    font-size: 13px;\n    line-height: 17px;\n    color: #c6d4df;\n}\n.popupTextTitle a {\n    text-decoration: underline;\n}\n.cookiepreferences_popup {\n\tdisplay: none;\n\tposition: fixed;\n\tbottom: 0;\n\twidth: 100%;\n\tz-index: 2000;\n\tpadding-top: 10px;\n}\n.cookiepreferences_popup_content {\n\tdisplay: flex;\n    box-sizing: border-box;\n\twidth: 90%;\n\tmargin: auto;\n\tmargin-bottom: 20px;\n\tpadding: 16px 16px 10px 16px;\n    max-width: 980px;\n\tbackground: linear-gradient(90.85deg, #333840 0.58%, #25282E 74.92%);\n\tbox-shadow: 0px 0px 10px #000000;\n    border-left: 2px solid #00CCFF;\n}\n@media all and (max-width: 910px) {\n    body.responsive_page .cookiepreferences_popup_content {\n        flex-direction: column;\n    }\n    body.responsive_page .cookiepreferences_popup_content .cookieMessage {\n        margin-bottom: 20px;\n    }\n    body.responsive_page .cookiepreferences_popup_content .buttonGroup {\n        flex-direction: row;\n        margin-left: 0px;\n    }\n    body.responsive_page .cookiepreferences_popup_content .buttonGroup .replyButton {\n        width: unset;\n    }\n}\n<\/style>\n\n<div id=\"cookiePrefPopup\" class=\"cookiepreferences_popup\">\n\t<div class=\"cookiepreferences_popup_content\">\n\t\t<div class=\"cookieMessage\">\n\t\t\t<div class=\"popupTextTitle\">Voc\u00ea se importa que usemos cookies opcionais para oferecer conte\u00fado personalizado e analisar o tr\u00e1fego no site?<\/div>\n\t\t\t<div class=\"popupTextTitle\">N\u00e3o usamos muitos cookies; voc\u00ea pode ver a lista deles e gerenci\u00e1-los a qualquer momento na <a href=\"https:\/\/store.steampowered.com\/account\/cookiepreferences\">p\u00e1gina de configura\u00e7\u00f5es de cookies<\/a>. Ao clicar no bot\u00e3o \"Aceitar todos\", voc\u00ea aceita o uso de cookies nos sites do Steam. Saiba mais sobre cookies na nossa <a href=\"https:\/\/store.steampowered.com\/privacy_agreement\">Pol\u00edtica de Privacidade<\/a>.<\/div>\n\t\t<\/div>\n\t\t<div class=\"buttonGroup\">\n\t\t\t<div id=\"acceptAllButton\" class=\"btn_blue_steamui btn_medium replyButton\"><span>Aceitar todos<\/span><\/div>\n\t\t\t<div id=\"rejectAllButton\" class=\"btn_grey_steamui btn_medium replyButton\"><span>Recusar todos<\/span><\/div>\n\t\t<\/div>\n\t<\/div>\n<\/div>\n" );
		...
		switch ( responseJSON.success )
		{
			...
			case 24:
				ShowAlertDialog( 'Erro',
					'A sua conta não atende aos requisitos para usar este recurso. <a class="whiteLink" href="https://help.steampowered.com/pt-br/wizard/HelpWithLimitedAccount" target="_blank" rel="noreferrer">Acesse o Suporte Steam</a> para mais informações.'
				);
				break;
			case 15:
				ShowAlertDialog( 'Erro', 'Você não possui permissão para realizar esta ação.' );
				break;
			default:
				ShowAlertDialog( 'Erro', 'Houve um erro ao processar a sua solicitação: ' + responseJSON.success );
				break;
		}
	} );
	return false;
...
CAjaxInfiniteScrollingControls.prototype.RestoreScrollTop = function( bForce )
{
	...
	if ( scrollTopPrevious )
	{
		...
		else
		{
			...
			{
				this.m_LoadingDialog = ShowBlockingWaitDialog( 'Aguarde', 'Retornando para onde você estava nesta página pela última vez...' );
			}
			window.scrollTo( 0, scrollTopPrevious );
		}
	}
...
function LockFamilyView( bStore )
{
	...
	ShowConfirmDialog( 'Ativar modo família',
		'Tem certeza de que deseja ativar o modo família?',
		'Ativar modo família'
	).done( function() {
		ShowBlockingWaitDialog( 'Ativar modo família' );
			...
			if ( typeof rgSuggestions[i][1] !== 'undefined' )
			{
				switch ( parseInt( rgSuggestions[i][1] ) )
				{
					case 1:
						...
						suggestionText = '[Jogo] ' + suggestionText;
						break;
					case 2:
						suggestionText = '[Aplicativo] ' + suggestionText;
						break;
					case 4:
						suggestionText = '[Ferramenta] ' + suggestionText;
						break;
					case 8:
						resultClass += ' app_Demo';
						suggestionText = '[Demonstração] ' + suggestionText;
						break;
					case 16:
						suggestionText = '[Mídia] ' + suggestionText;
						break;
					case 32:
						resultClass += ' app_DLC';
						suggestionText = '[Conteúdo adicional] ' + suggestionText;
						break;
					case 256:
						suggestionText = '[Configuração] ' + suggestionText;
						break;
					case 2048:
...
{
	var waitDialog = ShowBlockingWaitDialog( 'Exemplos de produtos', 'Aguarde enquanto buscamos exemplos de produtos...' );
	...
	$J.get( 'https://store.steampowered.com/search/results/',
		...
		{
			content.append( $J( "<div>", { class: "no_items", text: 'Nenhum produto encontrado' } ) );
		}

		var dialog = ShowAlertDialog( 'Exemplos de produtos', content );
	} );
}
