...
CLoginPromptManager.prototype.DoLogin = function()
{
	...
	$J.post( this.m_strBaseURL + 'getrsakey/', this.GetParameters( { username: username } ) )
		...
		.fail( function () {
			ShowAlertDialog( 'Hiba', 'Probléma adódott a Steam szerverekkel való kommunikáció során. Próbáld újra később.' );
...
CLoginPromptManager.prototype.OnRSAKeyResponse = function( results )
{
	...
	else
	{
		if ( results.message )
		{
			ShowAlertDialog( 'Hiba', results.message );
		}
		else
		{
			ShowAlertDialog( 'Hiba', 'Probléma adódott a Steam szerverekkel való kommunikáció során. Próbáld újra később.' );
...
CLoginPromptManager.prototype.StartTwoFactorAuthProcess = function()
{
	...
	var _this = this;
	this.m_TwoFactorModal = ShowDialog( 'Steam Guard mobilhitelesítés', this.m_$ModalTwoFactor.show() )
