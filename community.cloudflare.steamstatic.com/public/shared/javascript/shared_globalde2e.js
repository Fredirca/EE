...
{
	ShowConfirmDialog( 'Onko sinulla Steam?', 'Emme löytäneet käynnissä olevaa Steamiä laitteeltasi. Haluatko käynnistää verkkochatin?',
		'Käytä verkkochattia' , null, 'Lataa Steam' ).done( function( choice ) {
			if ( choice == 'OK' )
				fnLaunchWebchat();
			else
...
function InitCookiePreferencesPopup()
{
	...
	if ( $popupDialog.length == 0 )
	{
		...
		var $CPopupContent = $J( "<style>\n.replyButton {\n\twidth: 100%;\n    text-align: center;\n    margin-bottom: 4px;\n}\n\n.buttonGroup {\n\tflex: 18%;\n\tmargin-left: 20px;\n\tmargin-right: 0px;\n}\n.cookieMessage {\n\tflex: 85%;\n\tmargin: auto;\n}\n.popupTextTitle {\n\tpadding-bottom: 10px;\n    font-size: 13px;\n    line-height: 17px;\n    color: #c6d4df;\n}\n.popupTextTitle a {\n    text-decoration: underline;\n}\n.cookiepreferences_popup {\n\tdisplay: none;\n\tposition: fixed;\n\tbottom: 0;\n\twidth: 100%;\n\tz-index: 2000;\n\tpadding-top: 10px;\n}\n.cookiepreferences_popup_content {\n\tdisplay: flex;\n    box-sizing: border-box;\n\twidth: 90%;\n\tmargin: auto;\n\tmargin-bottom: 20px;\n\tpadding: 16px 16px 10px 16px;\n    max-width: 980px;\n\tbackground: linear-gradient(90.85deg, #333840 0.58%, #25282E 74.92%);\n\tbox-shadow: 0px 0px 10px #000000;\n    border-left: 2px solid #00CCFF;\n}\n@media all and (max-width: 910px) {\n    body.responsive_page .cookiepreferences_popup_content {\n        flex-direction: column;\n    }\n    body.responsive_page .cookiepreferences_popup_content .cookieMessage {\n        margin-bottom: 20px;\n    }\n    body.responsive_page .cookiepreferences_popup_content .buttonGroup {\n        flex-direction: row;\n        margin-left: 0px;\n    }\n    body.responsive_page .cookiepreferences_popup_content .buttonGroup .replyButton {\n        width: unset;\n    }\n}\n<\/style>\n\n<div id=\"cookiePrefPopup\" class=\"cookiepreferences_popup\">\n\t<div class=\"cookiepreferences_popup_content\">\n\t\t<div class=\"cookieMessage\">\n\t\t\t<div class=\"popupTextTitle\">Haluatko sallia ev\u00e4steet, joiden avulla tarjoamme sinulle r\u00e4\u00e4t\u00e4l\u00f6ity\u00e4 sis\u00e4lt\u00f6\u00e4 ja analysoimme sivun liikennett\u00e4?<\/div>\n\t\t\t<div class=\"popupTextTitle\">Emme k\u00e4yt\u00e4 paljon ev\u00e4steit\u00e4. Voit n\u00e4hd\u00e4 ja hallinnoida niit\u00e4 milloin tahansa <a href=\"https:\/\/store.steampowered.com\/account\/cookiepreferences\">Ev\u00e4steasetukset-sivulta<\/a>. Jos klikkaat Hyv\u00e4ksy kaikki, annat luvan k\u00e4ytt\u00e4\u00e4 ev\u00e4steit\u00e4 Steam-verkkosivuilla. Lis\u00e4tietoja ev\u00e4steist\u00e4 l\u00f6ytyy <a href=\"https:\/\/store.steampowered.com\/privacy_agreement\">tietosuojak\u00e4yt\u00e4nn\u00f6ist\u00e4mme<\/a>.<\/div>\n\t\t<\/div>\n\t\t<div class=\"buttonGroup\">\n\t\t\t<div id=\"acceptAllButton\" class=\"btn_blue_steamui btn_medium replyButton\"><span>Hyv\u00e4ksy kaikki<\/span><\/div>\n\t\t\t<div id=\"rejectAllButton\" class=\"btn_grey_steamui btn_medium replyButton\"><span>Hylk\u00e4\u00e4 kaikki<\/span><\/div>\n\t\t<\/div>\n\t<\/div>\n<\/div>\n" );
	...
	.fail( function( jqxhr ) {
		...
		switch ( responseJSON.success )
		{
			case 21:
				...
				break;
			case 24:
				ShowAlertDialog( 'Virhe',
					'Tilisi ei täytä tämän ominaisuuden käyttövaatimuksia. Saat lisätietoja <a class="whiteLink" href="https://help.steampowered.com/fi/wizard/HelpWithLimitedAccount" target="_blank" rel="noreferrer">Steamin tuesta</a>.'
				);
				break;
			case 15:
				ShowAlertDialog( 'Virhe', 'Sinulla ei ole oikeuksia tämän toiminnon suorittamiseen.' );
				break;
			default:
				ShowAlertDialog( 'Virhe', 'Pyyntösi käsittelyssä tapahtui virhe:' + responseJSON.success );
				break;
		}
	} );
	return false;
...
CAjaxInfiniteScrollingControls.prototype.RestoreScrollTop = function( bForce )
{
	...
	if ( scrollTopPrevious )
	{
		...
		else
		{
			...
			{
				this.m_LoadingDialog = ShowBlockingWaitDialog( 'Odota hetki', 'Palataan edelliseen vierailemaasi kohtaan sivulla...' );
			}
			window.scrollTo( 0, scrollTopPrevious );
		}
	}
...
function LockFamilyView( bStore )
{
	...
	ShowConfirmDialog( 'Palaa Perhenäkymään',
		'Haluatko varmasti palata Perhenäkymään?',
		'Palaa Perhenäkymään'
	).done( function() {
		ShowBlockingWaitDialog( 'Palaa Perhenäkymään' );
			...
			if ( typeof rgSuggestions[i][1] !== 'undefined' )
			{
				switch ( parseInt( rgSuggestions[i][1] ) )
				{
					case 1:
						...
						suggestionText = '[Peli] ' + suggestionText;
						break;
					case 2:
						suggestionText = '[Sovellus] ' + suggestionText;
						break;
					case 4:
						suggestionText = '[Työkalu] ' + suggestionText;
						break;
					case 8:
					...
					case 32:
						resultClass += ' app_DLC';
						suggestionText = '[Lisämateriaali] ' + suggestionText;
						break;
					case 256:
						suggestionText = '[Asetukset] ' + suggestionText;
						break;
					case 2048:
					...
					case 8192:
						...
						suggestionText = '[Musiikki] ' + suggestionText;
						break;
					case 65536:
...
{
	var waitDialog = ShowBlockingWaitDialog( 'Esimerkkituotteet', 'Odotathan, kun etsimme esimerkkituotteita...' );
	...
	$J.get( 'https://store.steampowered.com/search/results/',
		...
		{
			content.append( $J( "<div>", { class: "no_items", text: 'Tuotteita ei löytynyt' } ) );
		}

		var dialog = ShowAlertDialog( 'Esimerkkituotteet', content );
	} );
}
