		...
		$SelectBox.append(
			$J('<option/>', {value: "brazilian"} ).text( 'Português (Brasil)' )
				...
				$J('<option/>', {value: "bulgarian"} ).text( 'Български (Búlgaro)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "czech"} ).text( 'Čeština (Tcheco)' )
			);
					$SelectBox.append(
				...
				$J('<option/>', {value: "english"} ).text( 'English (Inglês)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "spanish"} ).text( 'Español-España (Espanhol — Espanha)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "latam"} ).text( 'Español-Latinoamérica (Espanhol — América Latina)' )
			);
					$SelectBox.append(
				...
				$J('<option/>', {value: "norwegian"} ).text( 'Norsk (Norueguês)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "polish"} ).text( 'Polski (Polonês)' )
			);
					$SelectBox.append(
