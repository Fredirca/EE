...
function Responsive_BuildChangeLanguageOption( $MenuItem )
{
	$MenuItem.click( function() {
		...
		$SelectBox.append(
			$J('<option/>', {value: "latam"} ).text( 'Español - Latinoamérica' )
		);
					$SelectBox.append(
				...
				$J('<option/>', {value: "english"} ).text( 'English (Inglés)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "spanish"} ).text( 'Español - España' )
			);
					$SelectBox.append(
				...
				$J('<option/>', {value: "portuguese"} ).text( 'Português (Portugués de Portugal)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "brazilian"} ).text( 'Português - Brasil (Portugués - Brasil)' )
			);
					$SelectBox.append(
