...
{
	ShowConfirmDialog( 'Έχετε το Steam;', 'Δεν μπορέσαμε να βρούμε το Steam να εκτελείται στη συσκευή σας. Θέλετε να εκκινήσετε τη διαδικτυακή συνομιλία;',
		'Διαδικτυακή συνομιλία' , null, 'Λήψη Steam' ).done( function( choice ) {
			if ( choice == 'OK' )
				fnLaunchWebchat();
			else
...
function InitCookiePreferencesPopup()
{
	...
	if ( $popupDialog.length == 0 )
	{
		...
		var $CPopupContent = $J( "<style>\n.replyButton {\n\twidth: 100%;\n    text-align: center;\n    margin-bottom: 4px;\n}\n\n.buttonGroup {\n\tflex: 18%;\n\tmargin-left: 20px;\n\tmargin-right: 0px;\n}\n.cookieMessage {\n\tflex: 85%;\n\tmargin: auto;\n}\n.popupTextTitle {\n\tpadding-bottom: 10px;\n    font-size: 13px;\n    line-height: 17px;\n    color: #c6d4df;\n}\n.popupTextTitle a {\n    text-decoration: underline;\n}\n.cookiepreferences_popup {\n\tdisplay: none;\n\tposition: fixed;\n\tbottom: 0;\n\twidth: 100%;\n\tz-index: 2000;\n\tpadding-top: 10px;\n}\n.cookiepreferences_popup_content {\n\tdisplay: flex;\n    box-sizing: border-box;\n\twidth: 90%;\n\tmargin: auto;\n\tmargin-bottom: 20px;\n\tpadding: 16px 16px 10px 16px;\n    max-width: 980px;\n\tbackground: linear-gradient(90.85deg, #333840 0.58%, #25282E 74.92%);\n\tbox-shadow: 0px 0px 10px #000000;\n    border-left: 2px solid #00CCFF;\n}\n@media all and (max-width: 910px) {\n    body.responsive_page .cookiepreferences_popup_content {\n        flex-direction: column;\n    }\n    body.responsive_page .cookiepreferences_popup_content .cookieMessage {\n        margin-bottom: 20px;\n    }\n    body.responsive_page .cookiepreferences_popup_content .buttonGroup {\n        flex-direction: row;\n        margin-left: 0px;\n    }\n    body.responsive_page .cookiepreferences_popup_content .buttonGroup .replyButton {\n        width: unset;\n    }\n}\n<\/style>\n\n<div id=\"cookiePrefPopup\" class=\"cookiepreferences_popup\">\n\t<div class=\"cookiepreferences_popup_content\">\n\t\t<div class=\"cookieMessage\">\n\t\t\t<div class=\"popupTextTitle\">\u039c\u03c0\u03bf\u03c1\u03bf\u03cd\u03bc\u03b5 \u03bd\u03b1 \u03c7\u03c1\u03b7\u03c3\u03b9\u03bc\u03bf\u03c0\u03bf\u03b9\u03ae\u03c3\u03bf\u03c5\u03bc\u03b5 \u03c0\u03c1\u03bf\u03b1\u03b9\u03c1\u03b5\u03c4\u03b9\u03ba\u03ac cookie \u03b3\u03b9\u03b1 \u03bd\u03b1 \u03c3\u03b1\u03c2 \u03c0\u03b1\u03c1\u03ad\u03c7\u03bf\u03c5\u03bc\u03b5 \u03b5\u03be\u03b1\u03c4\u03bf\u03bc\u03b9\u03ba\u03b5\u03c5\u03bc\u03ad\u03bd\u03bf \u03c0\u03b5\u03c1\u03b9\u03b5\u03c7\u03cc\u03bc\u03b5\u03bd\u03bf \u03ba\u03b1\u03b9 \u03b3\u03b9\u03b1 \u03bd\u03b1 \u03b1\u03bd\u03b1\u03bb\u03cd\u03bf\u03c5\u03bc\u03b5 \u03c4\u03b7\u03bd \u03ba\u03af\u03bd\u03b7\u03c3\u03b7 \u03c4\u03b7\u03c2 \u03b9\u03c3\u03c4\u03bf\u03c3\u03b5\u03bb\u03af\u03b4\u03b1\u03c2;<\/div>\n\t\t\t<div class=\"popupTextTitle\">\u0394\u03b5\u03bd \u03c7\u03c1\u03b7\u03c3\u03b9\u03bc\u03bf\u03c0\u03bf\u03b9\u03bf\u03cd\u03bc\u03b5 \u03c0\u03bf\u03bb\u03bb\u03ac cookie. \u039c\u03c0\u03bf\u03c1\u03b5\u03af\u03c4\u03b5 \u03bd\u03b1 \u03c4\u03b1 \u03b4\u03b5\u03af\u03c4\u03b5 \u03ba\u03b1\u03b9 \u03bd\u03b1 \u03c4\u03b1 \u03b4\u03b9\u03b1\u03c7\u03b5\u03b9\u03c1\u03b9\u03c3\u03c4\u03b5\u03af\u03c4\u03b5 \u03b1\u03bd\u03ac \u03c0\u03ac\u03c3\u03b1 \u03c3\u03c4\u03b9\u03b3\u03bc\u03ae \u03c3\u03c4\u03b9\u03c2 <a href=\"https:\/\/store.steampowered.com\/account\/cookiepreferences\">\u03a1\u03c5\u03b8\u03bc\u03af\u03c3\u03b5\u03b9\u03c2 cookie<\/a>. \u0391\u03bd \u03ba\u03ac\u03bd\u03b5\u03c4\u03b5 \u03ba\u03bb\u03b9\u03ba \u03c3\u03c4\u03b7\u03bd \u03b5\u03c0\u03b9\u03bb\u03bf\u03b3\u03ae \u00ab\u0391\u03c0\u03bf\u03b4\u03bf\u03c7\u03ae \u03cc\u03bb\u03c9\u03bd\u00bb, \u03c3\u03c5\u03bd\u03b1\u03b9\u03bd\u03b5\u03af\u03c4\u03b5 \u03c3\u03c4\u03b7 \u03c7\u03c1\u03ae\u03c3\u03b7 \u03c4\u03c9\u03bd cookie \u03c3\u03b5 \u03b9\u03c3\u03c4\u03bf\u03c3\u03b5\u03bb\u03af\u03b4\u03b5\u03c2 Steam. \u039c\u03ac\u03b8\u03b5\u03c4\u03b5 \u03c0\u03b5\u03c1\u03b9\u03c3\u03c3\u03cc\u03c4\u03b5\u03c1\u03b1 \u03b3\u03b9\u03b1 \u03c4\u03b1 cookie \u03c3\u03c4\u03b7\u03bd <a href=\"https:\/\/store.steampowered.com\/privacy_agreement\">\u03a0\u03bf\u03bb\u03b9\u03c4\u03b9\u03ba\u03ae \u0391\u03c0\u03bf\u03c1\u03c1\u03ae\u03c4\u03bf\u03c5<\/a> \u03bc\u03b1\u03c2.<\/div>\n\t\t<\/div>\n\t\t<div class=\"buttonGroup\">\n\t\t\t<div id=\"acceptAllButton\" class=\"btn_blue_steamui btn_medium replyButton\"><span>\u0391\u03c0\u03bf\u03b4\u03bf\u03c7\u03ae \u03cc\u03bb\u03c9\u03bd<\/span><\/div>\n\t\t\t<div id=\"rejectAllButton\" class=\"btn_grey_steamui btn_medium replyButton\"><span>\u0391\u03c0\u03cc\u03c1\u03c1\u03b9\u03c8\u03b7 \u03cc\u03bb\u03c9\u03bd<\/span><\/div>\n\t\t<\/div>\n\t<\/div>\n<\/div>\n" );
...
function RateAnnouncement( rateURL, gid, bVoteUp, clanID )
{
	...
	.fail( function( jqxhr ) {
		...
		{
			case 21:
				ShowAlertDialog( 'Σφάλμα', 'Πρέπει να έχετε συνδεθεί για να εκτελέσετε αυτή την ενέργεια.' );
				break;
			case 24:
				ShowAlertDialog( 'Σφάλμα',
					'Ο λογαριασμός σας δεν πληροί τις προϋποθέσεις για να χρησιμοποιήσει αυτή τη λειτουργία. <a class="whiteLink" href="https://help.steampowered.com/el/wizard/HelpWithLimitedAccount" target="_blank" rel="noreferrer">Επισκεφθείτε την Υποστήριξη Steam</a> για περισσότερες πληροφορίες.'
				);
				break;
			case 15:
				ShowAlertDialog( 'Σφάλμα', 'Δεν έχετε άδεια να εκτελέσετε αυτή την ενέργεια.' );
				break;
			default:
				ShowAlertDialog( 'Σφάλμα', 'Παρουσιάστηκε σφάλμα κατά την επεξεργασία του αιτήματός σας: ' + responseJSON.success );
				break;
		}
	} );
	return false;
...
CAjaxInfiniteScrollingControls.prototype.RestoreScrollTop = function( bForce )
{
	...
	if ( scrollTopPrevious )
	{
		...
		else
		{
			...
			{
				this.m_LoadingDialog = ShowBlockingWaitDialog( 'Περιμένετε', 'Επιστροφή στο τελευταίο σημείο που ήσασταν σε αυτή τη σελίδα...' );
			}
			window.scrollTo( 0, scrollTopPrevious );
		}
	}
...
function LockFamilyView( bStore )
{
	...
	ShowConfirmDialog( 'Επιστροφή στον Γονικό Έλεγχο',
		'Θέλετε σίγουρα να επιστρέψετε στον Γονικό Έλεγχο;',
		'Επιστροφή στον Γονικό Έλεγχο'
	).done( function() {
		ShowBlockingWaitDialog( 'Επιστροφή στον Γονικό Έλεγχο' );
			...
			if ( typeof rgSuggestions[i][1] !== 'undefined' )
			{
				switch ( parseInt( rgSuggestions[i][1] ) )
				{
					case 1:
						...
						suggestionText = '[Παιχνίδι] ' + suggestionText;
						break;
					case 2:
						suggestionText = '[Εφαρμογή] ' + suggestionText;
						break;
					case 4:
						suggestionText = '[Εργαλείο] ' + suggestionText;
						break;
					case 8:
						...
						break;
					case 16:
						suggestionText = '[Πολυμέσα] ' + suggestionText;
						break;
					case 32:
						resultClass += ' app_DLC';
						...
						break;
					case 256:
						suggestionText = '[Διαμόρφωση] ' + suggestionText;
						break;
					case 2048:
						resultClass += ' app_Movie';
						suggestionText = '[Βίντεο] ' + suggestionText;
						break;
					case 8192:
						resultClass += ' app_Music';
						suggestionText = '[Μουσική] ' + suggestionText;
						break;
					case 65536:
						resultClass += ' app_Beta';
						suggestionText = '[Έκδοση βήτα] ' + suggestionText;
						break;
				}
			}
...
{
	var waitDialog = ShowBlockingWaitDialog( 'Ενδεικτικά προϊόντα', 'Περιμένετε ενώ βρίσκουμε μερικά ενδεικτικά προϊόντα...' );
	...
	$J.get( 'https://store.steampowered.com/search/results/',
		...
		{
			content.append( $J( "<div>", { class: "no_items", text: 'Δεν βρέθηκαν προϊόντα' } ) );
		}

		var dialog = ShowAlertDialog( 'Ενδεικτικά προϊόντα', content );
	} );
}
