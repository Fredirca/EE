...
{
	ShowConfirmDialog( 'Máte klienta služby Steam?', 'Na Vašem zařízení není spuštěn klient služby Steam. Chcete přejít do webové konverzace?',
		'Použít web' , null, 'Nainstalovat Steam' ).done( function( choice ) {
			if ( choice == 'OK' )
				fnLaunchWebchat();
			else
...
function InitCookiePreferencesPopup()
{
	...
	if ( $popupDialog.length == 0 )
	{
		...
		var $CPopupContent = $J( "<style>\n.replyButton {\n\twidth: 100%;\n    text-align: center;\n    margin-bottom: 4px;\n}\n\n.buttonGroup {\n\tflex: 18%;\n\tmargin-left: 20px;\n\tmargin-right: 0px;\n}\n.cookieMessage {\n\tflex: 85%;\n\tmargin: auto;\n}\n.popupTextTitle {\n\tpadding-bottom: 10px;\n    font-size: 13px;\n    line-height: 17px;\n    color: #c6d4df;\n}\n.popupTextTitle a {\n    text-decoration: underline;\n}\n.cookiepreferences_popup {\n\tdisplay: none;\n\tposition: fixed;\n\tbottom: 0;\n\twidth: 100%;\n\tz-index: 2000;\n\tpadding-top: 10px;\n}\n.cookiepreferences_popup_content {\n\tdisplay: flex;\n    box-sizing: border-box;\n\twidth: 90%;\n\tmargin: auto;\n\tmargin-bottom: 20px;\n\tpadding: 16px 16px 10px 16px;\n    max-width: 980px;\n\tbackground: linear-gradient(90.85deg, #333840 0.58%, #25282E 74.92%);\n\tbox-shadow: 0px 0px 10px #000000;\n    border-left: 2px solid #00CCFF;\n}\n@media all and (max-width: 910px) {\n    body.responsive_page .cookiepreferences_popup_content {\n        flex-direction: column;\n    }\n    body.responsive_page .cookiepreferences_popup_content .cookieMessage {\n        margin-bottom: 20px;\n    }\n    body.responsive_page .cookiepreferences_popup_content .buttonGroup {\n        flex-direction: row;\n        margin-left: 0px;\n    }\n    body.responsive_page .cookiepreferences_popup_content .buttonGroup .replyButton {\n        width: unset;\n    }\n}\n<\/style>\n\n<div id=\"cookiePrefPopup\" class=\"cookiepreferences_popup\">\n\t<div class=\"cookiepreferences_popup_content\">\n\t\t<div class=\"cookieMessage\">\n\t\t\t<div class=\"popupTextTitle\">Souhlas\u00edte s t\u00edm, \u017ee pro poskytnut\u00ed personalizovan\u00e9ho obsahu a mo\u017enost anal\u00fdzy n\u00e1v\u0161t\u011bvnosti pou\u017eijeme voliteln\u00e9 soubory cookie?<\/div>\n\t\t\t<div class=\"popupTextTitle\">Na nere\u00e1ln\u00e9 su\u0161enky si moc nepotrp\u00edme. Co v\u00edc, v\u0161echny je m\u016f\u017eete kdykoli vid\u011bt a spravovat na str\u00e1nce <a href=\"https:\/\/store.steampowered.com\/account\/cookiepreferences\">Cookies a proch\u00e1zen\u00ed<\/a>. Kliknut\u00edm na \u201eP\u0159ijmout v\u0161echny\u201c potvrd\u00edte souhlas s pou\u017eit\u00edm soubor\u016f cookie na str\u00e1nk\u00e1ch slu\u017eby Steam. V\u00edce informac\u00ed naleznete v\u00a0<a href=\"https:\/\/store.steampowered.com\/privacy_agreement\">Z\u00e1sad\u00e1ch ochrany soukrom\u00ed<\/a>.<\/div>\n\t\t<\/div>\n\t\t<div class=\"buttonGroup\">\n\t\t\t<div id=\"acceptAllButton\" class=\"btn_blue_steamui btn_medium replyButton\"><span>P\u0159ijmout v\u0161echny<\/span><\/div>\n\t\t\t<div id=\"rejectAllButton\" class=\"btn_grey_steamui btn_medium replyButton\"><span>Odm\u00edtnout v\u0161echny<\/span><\/div>\n\t\t<\/div>\n\t<\/div>\n<\/div>\n" );
	...
	.fail( function( jqxhr ) {
		...
		switch ( responseJSON.success )
		{
			case 21:
				...
				break;
			case 24:
				ShowAlertDialog( 'Chyba',
					'Váš účet nesplňuje požadavky pro použití této funkce. Pro více informací navštivte <a class="whiteLink" href="https://help.steampowered.com/cs/wizard/HelpWithLimitedAccount" target="_blank" rel="noreferrer">podporu služby Steam</a>.'
				);
				break;
			case 15:
				ShowAlertDialog( 'Chyba', 'Pro tuto akci nemáte dostatečná oprávnění.' );
				break;
			default:
				ShowAlertDialog( 'Chyba', 'Při zpracovávání Vašeho požadavku došlo k chybě:' + responseJSON.success );
				break;
		}
	} );
	return false;
...
CAjaxInfiniteScrollingControls.prototype.RestoreScrollTop = function( bForce )
{
	...
	if ( scrollTopPrevious )
	{
		...
		else
		{
			...
			{
				this.m_LoadingDialog = ShowBlockingWaitDialog( 'Čekejte prosím', 'Budete vráceni na místo, kde jste naposledy byli na této stránce...' );
			}
			window.scrollTo( 0, scrollTopPrevious );
		}
	}
...
function LockFamilyView( bStore )
{
	...
	ShowConfirmDialog( 'Ano, chci',
		'Opravdu se chcete vrátit do rodinného režimu?',
		'Ano, chci'
	).done( function() {
		ShowBlockingWaitDialog( 'Ano, chci' );
			...
			if ( typeof rgSuggestions[i][1] !== 'undefined' )
			{
				switch ( parseInt( rgSuggestions[i][1] ) )
				{
					case 1:
						...
						suggestionText = '[Hra] ' + suggestionText;
						break;
					case 2:
						suggestionText = '[Aplikace] ' + suggestionText;
						break;
					case 4:
						suggestionText = '[Nástroj] ' + suggestionText;
						break;
					case 8:
						resultClass += ' app_Demo';
						suggestionText = '[Demoverze] ' + suggestionText;
						break;
					case 16:
						suggestionText = '[Médium] ' + suggestionText;
						break;
					case 32:
						resultClass += ' app_DLC';
						...
						break;
					case 256:
						suggestionText = '[Konfigurace] ' + suggestionText;
						break;
					case 2048:
					...
					case 8192:
						...
						suggestionText = '[Hudba] ' + suggestionText;
						break;
					case 65536:
						resultClass += ' app_Beta';
						suggestionText = '[Beta verze] ' + suggestionText;
						break;
				}
			}
...
{
	var waitDialog = ShowBlockingWaitDialog( 'Ukázkové produkty', 'Počkejte prosím, dokud nevyhledáme ukázkové produkty...' );
	...
	$J.get( 'https://store.steampowered.com/search/results/',
		...
		{
			content.append( $J( "<div>", { class: "no_items", text: 'Nebyly nalezeny žádné produkty' } ) );
		}

		var dialog = ShowAlertDialog( 'Ukázkové produkty', content );
	} );
}
