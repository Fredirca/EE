...
CLoginPromptManager.prototype.DoLogin = function()
{
	...
	$J.post( this.m_strBaseURL + 'getrsakey/', this.GetParameters( { username: username } ) )
		...
		.fail( function () {
			ShowAlertDialog( 'Feil', 'Det oppstod et problem under kommunikasjonen med Steams tjenere. Prøv igjen senere.' );
...
CLoginPromptManager.prototype.OnRSAKeyResponse = function( results )
{
	...
	else
	{
		if ( results.message )
		{
			ShowAlertDialog( 'Feil', results.message );
		}
		else
		{
			ShowAlertDialog( 'Feil', 'Det oppstod et problem under kommunikasjonen med Steams tjenere. Prøv igjen senere.' );
...
CLoginPromptManager.prototype.StartTwoFactorAuthProcess = function()
{
	...
	var _this = this;
	this.m_TwoFactorModal = ShowDialog( 'Mobilautentisering med Steam Guard', this.m_$ModalTwoFactor.show() )
