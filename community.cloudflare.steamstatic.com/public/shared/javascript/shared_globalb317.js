...
{
	ShowConfirmDialog( 'Steam をお持ちですか?', 'マシン上に実行中の Steam が見つかりません。Web チャットを起動しますか?',
		'Web チャットを使用' , null, 'Steam の入手' ).done( function( choice ) {
			if ( choice == 'OK' )
				fnLaunchWebchat();
			else
...
function InitCookiePreferencesPopup()
{
	...
	if ( $popupDialog.length == 0 )
	{
		...
		var $CPopupContent = $J( "<style>\n.replyButton {\n\twidth: 100%;\n    text-align: center;\n    margin-bottom: 4px;\n}\n\n.buttonGroup {\n\tflex: 18%;\n\tmargin-left: 20px;\n\tmargin-right: 0px;\n}\n.cookieMessage {\n\tflex: 85%;\n\tmargin: auto;\n}\n.popupTextTitle {\n\tpadding-bottom: 10px;\n    font-size: 13px;\n    line-height: 17px;\n    color: #c6d4df;\n}\n.popupTextTitle a {\n    text-decoration: underline;\n}\n.cookiepreferences_popup {\n\tdisplay: none;\n\tposition: fixed;\n\tbottom: 0;\n\twidth: 100%;\n\tz-index: 2000;\n\tpadding-top: 10px;\n}\n.cookiepreferences_popup_content {\n\tdisplay: flex;\n    box-sizing: border-box;\n\twidth: 90%;\n\tmargin: auto;\n\tmargin-bottom: 20px;\n\tpadding: 16px 16px 10px 16px;\n    max-width: 980px;\n\tbackground: linear-gradient(90.85deg, #333840 0.58%, #25282E 74.92%);\n\tbox-shadow: 0px 0px 10px #000000;\n    border-left: 2px solid #00CCFF;\n}\n@media all and (max-width: 910px) {\n    body.responsive_page .cookiepreferences_popup_content {\n        flex-direction: column;\n    }\n    body.responsive_page .cookiepreferences_popup_content .cookieMessage {\n        margin-bottom: 20px;\n    }\n    body.responsive_page .cookiepreferences_popup_content .buttonGroup {\n        flex-direction: row;\n        margin-left: 0px;\n    }\n    body.responsive_page .cookiepreferences_popup_content .buttonGroup .replyButton {\n        width: unset;\n    }\n}\n<\/style>\n\n<div id=\"cookiePrefPopup\" class=\"cookiepreferences_popup\">\n\t<div class=\"cookiepreferences_popup_content\">\n\t\t<div class=\"cookieMessage\">\n\t\t\t<div class=\"popupTextTitle\">\u30ab\u30b9\u30bf\u30de\u30a4\u30ba\u3055\u308c\u305f\u30b3\u30f3\u30c6\u30f3\u30c4\u3092\u63d0\u4f9b\u3057\u305f\u308a\u3001\u30b5\u30a4\u30c8\u30c8\u30e9\u30d5\u30a3\u30c3\u30af\u3092\u5206\u6790\u3057\u305f\u308a\u3059\u308b\u305f\u3081\u306b\u3001\u30aa\u30d7\u30b7\u30e7\u30f3\u306eCookie\u3092\u4f7f\u7528\u3057\u3066\u3082\u3088\u308d\u3057\u3044\u3067\u3059\u304b\uff1f<\/div>\n\t\t\t<div class=\"popupTextTitle\">\u4f7f\u7528\u3059\u308bCookie\u306e\u6570\u306f\u3042\u307e\u308a\u591a\u304f\u3042\u308a\u307e\u305b\u3093\u3002Cookie\u306f\u3001<a href=\"https:\/\/store.steampowered.com\/account\/cookiepreferences\">Cookie\u8a2d\u5b9a\u30da\u30fc\u30b8<\/a>\u3067\u3044\u3064\u3067\u3082\u7ba1\u7406\u3067\u304d\u307e\u3059\u3002\u300c\u3059\u3079\u3066\u53d7\u3051\u5165\u308c\u308b\u300d\u3092\u30af\u30ea\u30c3\u30af\u3059\u308b\u3068\u3001Steam Web\u30b5\u30a4\u30c8\u3067\u306eCookie\u306e\u4f7f\u7528\u306b\u540c\u610f\u3057\u305f\u3053\u3068\u306b\u306a\u308a\u307e\u3059\u3002Cookie\u306e\u8a73\u7d30\u306b\u3064\u3044\u3066\u306f\u3001\u5f0a\u793e\u306e<a href=\"https:\/\/store.steampowered.com\/privacy_agreement\">\u30d7\u30e9\u30a4\u30d0\u30b7\u30fc\u30dd\u30ea\u30b7\u30fc<\/a>\u3092\u3054\u89a7\u304f\u3060\u3055\u3044\u3002<\/div>\n\t\t<\/div>\n\t\t<div class=\"buttonGroup\">\n\t\t\t<div id=\"acceptAllButton\" class=\"btn_blue_steamui btn_medium replyButton\"><span>\u3059\u3079\u3066\u53d7\u3051\u5165\u308c\u308b<\/span><\/div>\n\t\t\t<div id=\"rejectAllButton\" class=\"btn_grey_steamui btn_medium replyButton\"><span>\u3059\u3079\u3066\u62d2\u5426\u3059\u308b<\/span><\/div>\n\t\t<\/div>\n\t<\/div>\n<\/div>\n" );
...
function RateAnnouncement( rateURL, gid, bVoteUp, clanID )
{
	...
	.fail( function( jqxhr ) {
		...
		switch ( responseJSON.success )
		{
			...
			case 24:
				ShowAlertDialog( 'エラー',
					'あなたのアカウントはこの機能を使用するための要件を満たしていません。詳細については<a class="whiteLink" href="https://help.steampowered.com/ja/wizard/HelpWithLimitedAccount" target="_blank" rel="noreferrer">Steam サポート</a>をご覧ください。'
				);
				break;
			case 15:
				ShowAlertDialog( 'エラー', 'このアクションを行う権限がありません。' );
				break;
			default:
				ShowAlertDialog( 'エラー', 'リクエストの処理中にエラーが発生しました: ' + responseJSON.success );
				break;
		}
	} );
	return false;
...
CAjaxInfiniteScrollingControls.prototype.RestoreScrollTop = function( bForce )
{
	...
	if ( scrollTopPrevious )
	{
		...
		else
		{
			...
			{
				this.m_LoadingDialog = ShowBlockingWaitDialog( 'お待ちください', 'このページで最後に表示していた場所まで戻ります...' );
			}
			window.scrollTo( 0, scrollTopPrevious );
		}
	}
...
function LockFamilyView( bStore )
{
	...
	ShowConfirmDialog( 'ファミリービューに戻る',
		'ファミリービューに戻りますか？',
		'ファミリービューに戻る'
	).done( function() {
		ShowBlockingWaitDialog( 'ファミリービューに戻る' );
			...
			if ( typeof rgSuggestions[i][1] !== 'undefined' )
			{
				switch ( parseInt( rgSuggestions[i][1] ) )
				{
					case 1:
						...
						suggestionText = '[ゲーム] ' + suggestionText;
						break;
					case 2:
						suggestionText = '[アプリケーション] ' + suggestionText;
						break;
					case 4:
						suggestionText = '[ツール] ' + suggestionText;
						break;
					case 8:
						resultClass += ' app_Demo';
						suggestionText = '[体験版] ' + suggestionText;
						break;
					case 16:
						suggestionText = '[メディア] ' + suggestionText;
						break;
					case 32:
						resultClass += ' app_DLC';
						...
						break;
					case 256:
						suggestionText = '[設定] ' + suggestionText;
						break;
					case 2048:
						resultClass += ' app_Movie';
						suggestionText = '[動画] ' + suggestionText;
						break;
					case 8192:
						resultClass += ' app_Music';
						suggestionText = '[ミュージック] ' + suggestionText;
						break;
					case 65536:
						resultClass += ' app_Beta';
						suggestionText = '[ベータ] ' + suggestionText;
						break;
				}
			}
...
{
	var waitDialog = ShowBlockingWaitDialog( '製品例', '製品例が見つかるまでしばらくお待ちください...' );
	...
	$J.get( 'https://store.steampowered.com/search/results/',
		...
		{
			content.append( $J( "<div>", { class: "no_items", text: '製品が見つかりません' } ) );
		}

		var dialog = ShowAlertDialog( '製品例', content );
	} );
}
