...
{
	ShowConfirmDialog( 'Hai già Steam?', 'Non abbiamo trovato Steam in esecuzione sul tuo dispositivo. Desideri avviare la chat web?',
		'Usa la chat web' , null, 'Scarica Steam' ).done( function( choice ) {
			if ( choice == 'OK' )
				fnLaunchWebchat();
			else
...
function InitCookiePreferencesPopup()
{
	...
	if ( $popupDialog.length == 0 )
	{
		...
		var $CPopupContent = $J( "<style>\n.replyButton {\n\twidth: 100%;\n    text-align: center;\n    margin-bottom: 4px;\n}\n\n.buttonGroup {\n\tflex: 18%;\n\tmargin-left: 20px;\n\tmargin-right: 0px;\n}\n.cookieMessage {\n\tflex: 85%;\n\tmargin: auto;\n}\n.popupTextTitle {\n\tpadding-bottom: 10px;\n    font-size: 13px;\n    line-height: 17px;\n    color: #c6d4df;\n}\n.popupTextTitle a {\n    text-decoration: underline;\n}\n.cookiepreferences_popup {\n\tdisplay: none;\n\tposition: fixed;\n\tbottom: 0;\n\twidth: 100%;\n\tz-index: 2000;\n\tpadding-top: 10px;\n}\n.cookiepreferences_popup_content {\n\tdisplay: flex;\n    box-sizing: border-box;\n\twidth: 90%;\n\tmargin: auto;\n\tmargin-bottom: 20px;\n\tpadding: 16px 16px 10px 16px;\n    max-width: 980px;\n\tbackground: linear-gradient(90.85deg, #333840 0.58%, #25282E 74.92%);\n\tbox-shadow: 0px 0px 10px #000000;\n    border-left: 2px solid #00CCFF;\n}\n@media all and (max-width: 910px) {\n    body.responsive_page .cookiepreferences_popup_content {\n        flex-direction: column;\n    }\n    body.responsive_page .cookiepreferences_popup_content .cookieMessage {\n        margin-bottom: 20px;\n    }\n    body.responsive_page .cookiepreferences_popup_content .buttonGroup {\n        flex-direction: row;\n        margin-left: 0px;\n    }\n    body.responsive_page .cookiepreferences_popup_content .buttonGroup .replyButton {\n        width: unset;\n    }\n}\n<\/style>\n\n<div id=\"cookiePrefPopup\" class=\"cookiepreferences_popup\">\n\t<div class=\"cookiepreferences_popup_content\">\n\t\t<div class=\"cookieMessage\">\n\t\t\t<div class=\"popupTextTitle\">Possiamo usare dei cookie facoltativi per fornirti contenuti personalizzati e analizzare il traffico del sito?<\/div>\n\t\t\t<div class=\"popupTextTitle\">Non usiamo molti cookie. Puoi visualizzarli e gestirli in qualunque momento nella nostra <a href=\"https:\/\/store.steampowered.com\/account\/cookiepreferences\">pagina di impostazione dei cookie<\/a>. Se fai clic su \"Accetta tutti\", acconsenti all'uso dei cookie sui siti web di Steam. Per ulteriori informazioni sui cookie consulta la nostra <a href=\"https:\/\/store.steampowered.com\/privacy_agreement\">Informativa sulla privacy<\/a>.<\/div>\n\t\t<\/div>\n\t\t<div class=\"buttonGroup\">\n\t\t\t<div id=\"acceptAllButton\" class=\"btn_blue_steamui btn_medium replyButton\"><span>Accetta tutti<\/span><\/div>\n\t\t\t<div id=\"rejectAllButton\" class=\"btn_grey_steamui btn_medium replyButton\"><span>Rifiuta tutti<\/span><\/div>\n\t\t<\/div>\n\t<\/div>\n<\/div>\n" );
		...
		switch ( responseJSON.success )
		{
			...
			case 24:
				ShowAlertDialog( 'Errore',
					'Il tuo account non soddisfa i requisiti necessari per l\'uso di questa funzionalità. <a class="whiteLink" href="https://help.steampowered.com/it/wizard/HelpWithLimitedAccount" target="_blank" rel="noreferrer">Visita l\'Assistenza di Steam</a> per ulteriori informazioni.'
				);
				break;
			case 15:
				ShowAlertDialog( 'Errore', 'Non hai i permessi necessari per poter eseguire quell\'azione.' );
				break;
			default:
				ShowAlertDialog( 'Errore', 'Si è verificato un errore durante l\'elaborazione della tua richiesta: ' + responseJSON.success );
				break;
		}
	} );
	return false;
...
CAjaxInfiniteScrollingControls.prototype.RestoreScrollTop = function( bForce )
{
	...
	if ( scrollTopPrevious )
	{
		...
		else
		{
			...
			{
				this.m_LoadingDialog = ShowBlockingWaitDialog( 'Attendi', 'Ritorno all\'ultimo punto di questa pagina che hai visitato...' );
			}
			window.scrollTo( 0, scrollTopPrevious );
		}
	}
...
function LockFamilyView( bStore )
{
	...
	ShowConfirmDialog( 'Torna alla Visuale per la famiglia',
		'Sei sicuro di voler ripristinare la Visuale per la famiglia?',
		'Torna alla Visuale per la famiglia'
	).done( function() {
		ShowBlockingWaitDialog( 'Torna alla Visuale per la famiglia' );
			...
			if ( typeof rgSuggestions[i][1] !== 'undefined' )
			{
				switch ( parseInt( rgSuggestions[i][1] ) )
				{
					case 1:
						...
						suggestionText = '[Gioco] ' + suggestionText;
						break;
					case 2:
						suggestionText = '[Applicazione] ' + suggestionText;
						break;
					case 4:
						suggestionText = '[Strumento] ' + suggestionText;
						break;
					case 8:
						...
						break;
					case 16:
						suggestionText = '[Contenuto multimediale] ' + suggestionText;
						break;
					case 32:
						resultClass += ' app_DLC';
						...
						break;
					case 256:
						suggestionText = '[Configurazione] ' + suggestionText;
						break;
					case 2048:
					...
					case 8192:
						...
						suggestionText = '[Musica] ' + suggestionText;
						break;
					case 65536:
...
{
	var waitDialog = ShowBlockingWaitDialog( 'Prodotti di esempio', 'Attendi mentre troviamo dei prodotti di esempio...' );
	...
	$J.get( 'https://store.steampowered.com/search/results/',
		...
		{
			content.append( $J( "<div>", { class: "no_items", text: 'Nessun prodotto trovato' } ) );
		}

		var dialog = ShowAlertDialog( 'Prodotti di esempio', content );
	} );
}
